import { parseTableName } from '@sinapsis-cloud-components/sdk/integration/store/dynamo/util/parse-name';
import { RemovalPolicy } from 'aws-cdk-lib';
import { AttributeType, BillingMode, Table } from 'aws-cdk-lib/aws-dynamodb';
import { NodejsFunction } from 'aws-cdk-lib/aws-lambda-nodejs';
import { Construct } from 'constructs';

import { TablePermission } from '@sinapsis-cloud-components/sdk/catalog/api';
import { TableStoreBuilder } from '@sinapsis-cloud-components/sdk/integration/store/dynamo/types/table-store-builder';
