...
import { CdnApiConstruct, CdnApiConstructParams } from '@sinapsis-co/cc-core/services/cdn-api';
...
} & Pick<CdnApiConstructParams, 'albDefaultBehavior'>;
...
export class CdnApi extends Service<GlobalProps, CdnApiParams> {
  ...
  constructor(scope: Construct, globalProps: GlobalProps, params: CdnApiParams) {
    ...
    const cdnApiRest = new CdnApiConstruct(this, {
      ...
      albDefaultBehavior: params.albDefaultBehavior,
    });
