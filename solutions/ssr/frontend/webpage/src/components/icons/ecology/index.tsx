...
interface EcologyIconProps extends React.SVGProps<SVGSVGElement> {
  className?: string;
}

const EcologyIcon: FunctionComponent<EcologyIconProps> = ({ className, ...props }) => {
  const rotate = {
    animate: {
      rotate: 360,
  ...
  return (
    <svg className={className || ''} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 770 770" {...props}>
      <g id="bg">
      ...
      <motion.g variants={rotate} animate="animate">
        <path
          fill="#fff"
      ...
      <g id="helmet">
        ...
        />
        <path d="m419.8,350.6c0,8.8-6.9,15.9-15.7,15.9-8.8.1-16-7.1-16-16.1.1-8.7,7.2-15.8,15.9-15.8,8.7.2,15.7,7.2,15.8,16Zm-11.1.9v-1.7c-1.6-1.1-3-2.8-4.7-3.1-2.5-.5-4,1.4-4.1,3.9s1.6,4.3,4,4c1.7-.3,3.2-2,4.8-3.1Z" />
        <path d="m448,437.6c-.2,8.6-7.7,15.6-16.3,15.3-8.7-.3-15.5-7.5-15.3-16.3.2-8.7,7.5-15.8,16.1-15.5,8.9.2,15.7,7.5,15.5,16.5Zm-16.8,4.1h1.7c1.1-1.5,2.9-3,3.2-4.6.4-2.4-1.4-4-3.9-4s-4.3,1.5-4,3.9c.3,1.6,2,3.1,3,4.7Z" />
        <path d="m357,222c2.8-.2,4.9.9,5.1,3.8.2,2.8-1.6,4.1-4.2,4.5-20.7,2.8-39.5,10.4-56.8,21.9-2.4,1.6-4.8,2.2-6.7-.5-1.8-2.5-.7-4.6,1.6-6.1,18.1-12.2,37.8-20.3,59.5-23.5.4-.1,1-.1,1.5-.1Z" />
        <path d="m380.7,228.4c-2.8.2-5.6.4-8.4.5-2.7.1-4.5-1.2-4.7-3.9-.2-2.6,1.5-4.2,3.9-4.3,6.9-.3,13.7-.3,20.6-.3,2.8,0,4.7,1.6,4.4,4.5-.3,3.2-2.6,3.9-5.6,3.8-3.4-.2-6.9,0-10.3,0q.1-.2.1-.3Z" />
