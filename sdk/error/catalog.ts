...
type CognitoFaults =
  ...
  | 'FAULT_COG_CONFIRM_SIGN_UP'
  | 'FAULT_COG_CONFIRM_FORGOT_PASSWORD'
  | 'FAULT_COG_FORGOT_PASSWORD'
  | 'FAULT_COG_RESEND_CONFIRMATION_CODE';
...
export type PlatformFaultCodes =
  ...
  | 'FAULT_NOT_MISSING_TRANSLATION_FILE'
  | 'FAULT_NOT_MISSING_TEMPLATE_FILE'
  | 'FAULT_NOT_MISSING_TRANSLATION_LANG'
