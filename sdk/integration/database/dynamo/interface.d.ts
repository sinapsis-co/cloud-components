...
export type EntityCreate<Builder extends EntityBuilderKeys, Omitted extends keyof Builder['body'] = ''> = Omit<Builder['body'], Omitted> & Partial<Pick<Builder, 'timers'>>;
export type EntityUpdate<Builder extends EntityBuilderKeys> = Builder['body'];
export type EntityStore<Builder extends EntityBuilderKeys, Table extends TableBuilder> = Builder['body'] & Table['storeMapping']['key'] & Table['storeMapping']['timers'];
export type RepositoryConfig<Builder extends EntityBuilder, Table extends TableBuilder, Create = EntityCreate<Builder>> = {
