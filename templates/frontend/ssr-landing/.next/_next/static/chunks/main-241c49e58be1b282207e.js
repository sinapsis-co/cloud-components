  ...
  [14],
  {
    ...
    IKlv: function (e, t, r) {
      ...
      var R = function (e) {
        ...
        Y = M.defaultLocale,
        z = q || '';
      (r.p = ''.concat(z, '/_next/')), E.setConfig({ serverRuntimeConfig: {}, publicRuntimeConfig: j || {} });
      var U = (0, x.getURL)();
              ...
              },
              {
                ...
                value: function () {
                  this.scrollToHash(),
                    !K.isSsr ||
                      '/404' === I ||
                      ('/_error' === I && L && L.pageProps && 404 === L.pageProps.statusCode) ||
                      !(
                        H ||
                        (M.nextExport && ((0, w.isDynamicRoute)(K.pathname) || location.search)) ||
                        (L && L.__N_SSG && location.search)
                      ) ||
                      K.replace(
                        K.pathname +
                          '?' +
                          String(_.assign(_.urlQueryToSearchParams(K.query), new URLSearchParams(location.search))),
                        U,
                        { _h: 1, shallow: !H }
                      );
                },
                  ...
                  switch ((e.prev = e.next)) {
                    ...
                    case 36:
                      return (
                        ...
                        ue((c = { App: $, initial: !0, Component: ne, props: L, err: r })),
                        e.abrupt('return', ae)
                      );
                    case 43:
          ...
          Q.loadPage('/_error').then(function (n) {
            var o = n.page,
              ...
              u = {
                ...
                AppTree: i,
                router: K,
                ctx: { err: r, pathname: I, query: D, asPath: U, AppTree: i },
              };
