  ...
  [12],
  {
    ...
    GNXZ: function (t, n, e) {
      ...
      var o = e('1OyB'),
        ...
        b = s.createElement,
        v = Object(p.d)(['font-size:12px;top:12px;font-weight:400;line-height:normal;color:', ';'], function (t) {
          var n = t.theme;
          return Object(d.a)(n.colors.primary, 0.5);
        }),
        g = Object(p.d)(['top:22px;font-size:14px;font-weight:400;line-height:16px;color:', ';'], function (t) {
          return t.theme.colors.primary;
        }),
        x = Object(p.e)(function (t) {
      ...
      n.a = Object(p.e)(O).withConfig({ displayName: 'input', componentId: 'ykvnzj-0' })(
        [
    ...
    XGvB: function (t, n, e) {
      ...
      var s = a.e.path.withConfig({ displayName: 'search__Handle', componentId: 'sc-1pnq8jm-0' })(
        ...
        v = Object(a.e)(function (t) {
          return h(
            ...
            h(
              ...
              h(x, { className: 'dropdown-text' }, t.label || t.title),
              h(m, { className: 'label' }, t.title)
            ),
            t.error ? h(b, null, t.error) : null,
            t.disabled ? null : h(g, null, h(w, { arrowUp: t.listOpen }))
          );
        ...
        g = a.e.div.withConfig({ displayName: 'dropdown-header__IconWrapper', componentId: 'tlc708-3' })([
          'position:absolute;top:50%;right:18px;transform:translate(0,-50%);',
        ]),
        x = a.e.span.withConfig({ displayName: 'dropdown-header__DropdownText', componentId: 'tlc708-4' })(
          [
