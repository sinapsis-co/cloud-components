      ...
      !(function () {
        ...
        i.prototype = {
            ...
            if (!(_ >= p)) {
              ...
              if (t._webAudio) {
                ...
                if (m.readyState >= 3 || v) y();
                  ...
                  t._playLock = !0;
                  var A = function () {
                    y(), m.removeEventListener(a._canPlayEvent, A, !1);
                  };
                  m.addEventListener(a._canPlayEvent, A, !1), t._clearTimer(u._id);
                }
              }
              return u._id;
            }
            ...
            for (var i = r._getSoundIds(o), u = 0; u < i.length; u++) {
              ...
              if (d) {
                if ((o || r._stopFade(i[u]), r._webAudio && !d._muted)) {
                  var _ = a.ctx.currentTime,
                    s = _ + t / 1e3;
                  (d._volume = e), d._node.gain.setValueAtTime(e, _), d._node.gain.linearRampToValueAtTime(n, s);
                }
          ...
          unload: function () {
            ...
            return (
              d && r && delete d[e._src], (a.noAudio = !1), (e._state = 'unloaded'), (e._sounds = []), (e = null), null
            );
          },
          on: function (e, n, t, o) {
            var r = this['_on' + e];
        ...
        var d = {},
          ...
          p = function () {
            if (a.usingWebAudio) {
              ...
              a.usingWebAudio &&
                ((a.masterGain = 'undefined' === typeof a.ctx.createGain ? a.ctx.createGainNode() : a.ctx.createGain()),
