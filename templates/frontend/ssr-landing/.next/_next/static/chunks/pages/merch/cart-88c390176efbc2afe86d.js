      ...
      function w(t) {
        ...
        return m(
          ...
          m(
            ...
            f.length
              ? m(i.a.Fragment, null, m(p.a, { cartKey: n.ownerId, onCartChanged: y }), m(b.a, { subtotal: h }))
              : m(O, null, 'Cart is empty.'),
            f.length ? m(g, { onClick: C, disabled: x }, 'Proceed to Checkout') : null
          )
        );
      }
      var g = Object(f.e)(h.a).withConfig({ displayName: 'cart__CartButton', componentId: 'sc-18dr43p-0' })([
          'width:100%;height:70px;margin:32px auto 64px;',
        ]),
        O = f.e.p.withConfig({ displayName: 'cart__StyledEmptyCartMessage', componentId: 'sc-18dr43p-1' })(
