      ...
      t.default = function (e) {
        ...
        return M(
          ...
          M(
            i.a,
            null,
            M('meta', { name: 'msapplication-TileColor', content: '#ffffff' }),
            M('meta', { name: 'msapplication-TileImage', content: 'favicon/ms-icon-144x144.png' }),
            M('meta', { name: 'theme-color', content: '#ffffff' }),
            M('meta', { name: 'viewport', content: 'width=device-width, initial-scale=1' }),
            M('meta', { name: 'theme-color', content: '#F4514D' })
          ),
          M(
            s.Elements,
            {
