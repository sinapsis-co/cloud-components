    ...
    E7Mf: function (n, t, e) {
      ...
      function d(n) {
        ...
        return p(
          ...
          p(w, null, 'Your order No:', i, ' has been placed.'),
          p(w, { className: 'has-marign' }, 'We sent an email to ', e, ' with your order confirmation and bill.', ' ')
        );
      }
        ...
        return t && t.id
          ? x(
              ...
              x(
                ...
                x(d, { orderId: '1029482', userEmail: 'hernan@sinapsis.co' })
              )
            )
          : null;
      }
