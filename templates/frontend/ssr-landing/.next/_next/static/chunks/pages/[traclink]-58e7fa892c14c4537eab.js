_N_E = (window.webpackJsonp_N_E = window.webpackJsonp_N_E || []).push([
  [13],
  {
      ...
      t.r(n),
        function (e) {
          ...
          var y = ['spotify', 'deezer', 'napster'],
            g = ['custom', 'spotify', 'appleMusic', 'tidal', 'amazonMusic', 'youtube', 'deezer', 'pandora', 'napster'],
            b = !0;
          function w(n) {
            var t = Object(f.a)(n.pageData).pageData,
              o = Object(r.useState)([]),
              u = o[0],
              c = o[1],
              h = function () {
                var e;
                return (
                  !(!t || null === (e = t.data) || void 0 === e || !e.releaseDate) &&
                  t.data.releaseDate > Number(new Date())
                );
              };
            return (
              Object(r.useEffect)(
                          ...
                          ? n
                              ...
                              .map(function (n) {
                                return v(
                                  ...
                                  {},
                                  {
                                    url: ((o = n), o.platform ? Object(_.a)(o.platform, t.id, 'save') : ''),
                                    isSuccess: e(n),
                                  }
                                );
                                var o;
              ...
              t && t.data
                ? m(
                    ...
                    null,
                    m(i.a, {
                      title: ''.concat(t.data.artistName, ' | ').concat(t.title),
                      description: ''.concat(t.data.artistName, ' | ').concat(t.title),
                      openGraph: {
                        title: ''.concat(t.data.artistName, ' | ').concat(t.title),
                        description: ''.concat(t.data.artistName, ' | ').concat(t.title),
                        url: 'https://'
                          .concat(n.subdomain, '.')
                          .concat(e.env.NEXT_PUBLIC_APP_BASE_DOMAIN, '/')
                          .concat(t.path),
                        images: [{ url: t.avatar }],
                        type: 'website',
                      },
                    ...
                    m(
                      ...
                      m(
                        A,
                        null,
                        m(s.a, { data: t.data, isPreSave: h(), title: t.title }),
                        m(
                          x,
                          { className: 'mt-60' },
                          u
                            ...
                            .map(function (e, n) {
                              return m(d.a, { key: n, data: e, className: 'mt-5' });
                            })
                        )
                      ),
                      t.data.tracks && t.data.tracks.length > 0 && m(l.a, { data: t.data, title: t.title })
                    )
                  )
                : null
            );
          }
          var A = Object(c.e)(u.a).withConfig({
              displayName: 'traclink__StyledContainer',
              componentId: 'sc-1fpre7y-0',
            })(['justify-content:center;flex-direction:column;margin-bottom:100px;']),
            x = c.e.div.withConfig({ displayName: 'traclink__LinksContainer', componentId: 'sc-1fpre7y-1' })([
              'width:100%;',
            ]);
        }.call(this, t('8oxB'));
    },
    ...
    VxFy: function (e, n, t) {
      ...
      function d(e) {
        ...
        return u(
          ...
          null,
          n.videoUrl
            ? u(a.a, { variant: 'small', data: { title: t, url: n.videoUrl } })
            : u(l, { src: n.coverUrl, alt: t }),
          u(
            c,
            null,
            u('span', null, n.artistName),
            u('h1', null, t),
            o && u(_, null, 'Coming soon, pre-save this release to your library')
          )
        );
      }
      var s = i.e.div.withConfig({ displayName: 'traclink-info__InfoContainer', componentId: 'lff03t-0' })([
          'display:flex;flex-direction:column;align-items:center;',
        ]),
        l = i.e.img.withConfig({ displayName: 'traclink-info__CoverImage', componentId: 'lff03t-1' })([
          'border-radius:5px;width:212px;height:212px;',
        ]),
        c = i.e.div.withConfig({ displayName: 'traclink-info__Info', componentId: 'lff03t-2' })(
          [
        ...
        _ = i.e.span.withConfig({ displayName: 'traclink-info__PreSaveLabel', componentId: 'lff03t-3' })([
          'font-size:16px;',
        ]);
    },
    ZQnd: function (e, n, t) {
    ...
    nrNT: function (e, n, t) {
      ...
      var l = Object(a.e)(i.b.div).withConfig({
      ...
      function p(e) {
        return _(
          'svg',
          Object(c.a)({ viewBox: '0 0 16 16' }, e),
          _('path', {
            fill: e.fill,
      ...
      function v(e) {
        return h(
          ...
          h(
            ...
            h(g, null, h('span', null, e.songName), e.isPlaying ? h(m, null) : null)
          )
        );
      }
      var y = Object(a.e)(i.b.div).withConfig({
        ...
        g = a.e.div.withConfig({ displayName: 'traclink-release-item__SongName', componentId: 'p9uhcv-1' })(
      ...
      var A = Object(a.e)(i.b.div).withConfig({
        ...
        x = a.e.span.withConfig({ displayName: 'traclink-release__ReleaseTypeTitle', componentId: 'xnmvxw-1' })(
      ...
      function I(e) {
        return k(
          'svg',
          Object(c.a)({ width: '14', height: '14', viewBox: '0 0 14 14' }, e),
          k('path', {
            d: 'M2 2V12',
            stroke: 'white',
            strokeWidth: '4',
          ...
          function () {
            return (function (e) {
              ...
              return (
                e &&
                  (P(0),
                  (l.current = new u.Howl({ src: [e], html5: !0, autoplay: !0 })),
                  l.current.on('play', function () {
                    y(!0);
                  }),
                  (n = setInterval(function () {
                    var e;
                    if (null !== (e = l.current) && void 0 !== e && e.playing()) {
                      var n,
                        t,
                        o = (null === (n = l.current) || void 0 === n ? void 0 : n.seek()) || 0,
                        r = (null === (t = l.current) || void 0 === t ? void 0 : t.duration()) || 1;
                      P((o / r) * 100);
                    }
                  }, 50)),
                  l.current.on('pause', function () {
                    var e;
                    return y((null === (e = l.current) || void 0 === e ? void 0 : e.playing()) || !1);
                  }),
                  l.current.on('end', function () {
                    return y(!1);
                  })),
                function () {
                  var e;
                  clearInterval(n),
                    l.current && (null === (e = l.current) || void 0 === e || e.off(), l.current.unload());
                }
              );
            })(_);
          },
        ...
        var D =
          (null === (n = r.tracks) || void 0 === n
            ...
            : n
                ...
                .map(function (e) {
                  return { songName: e.title, url: e.url, isPlaying: e.url === _ && v };
                })) || [];
        return O(
          F,
          null,
          O(
            N,
            { className: ''.concat(t, ' ').concat(b ? 'open' : '') },
            O(
              M,
              null,
              O(S.a, { src: r.coverUrl, alt: r.title, variant: 'squareSmall' }),
              O(B, null, O('span', null, r.title), O('label', null, r.artistName))
            ),
            O(
              H,
              {
                onClick: function (e) {
                  ...
                  (e.stopPropagation(), v || _)
                    ? v
                      ? null === (n = l.current) || void 0 === n || n.pause()
                      : null === (t = l.current) || void 0 === t || t.play()
                    : f(D[0].url);
                },
              },
              O(v ? I : T.a, { fill: C.palette.white })
            ),
            null !== D && void 0 !== D && D.length
              ? O(
                  ...
                  O(
                    ...
                    '\xa0',
                    1 === (null === D || void 0 === D ? void 0 : D.length) ? 'Song' : 'Songs'
                  )
                )
              : null
          ),
          ...
          O(L, { progressbarWidth: k }, O('span', null))
        );
      }
      var F = a.e.div.withConfig({ displayName: 'traclink-player__PlayerContainer', componentId: 'sc-4jg59k-0' })(
          [
        ...
        N = a.e.div.withConfig({ displayName: 'traclink-player__PlayerNav', componentId: 'sc-4jg59k-1' })(
          [
        ...
        L = a.e.div.withConfig({ displayName: 'traclink-player__TraclinkProgressbar', componentId: 'sc-4jg59k-2' })(
          [
        ...
        H = a.e.button.withConfig({ displayName: 'traclink-player__ActionButton', componentId: 'sc-4jg59k-3' })(
          [
        ...
        E = a.e.div.withConfig({ displayName: 'traclink-player__SongsInfo', componentId: 'sc-4jg59k-4' })(
          ['> span{font-size:14px;line-height:24px;color:', ';font-weight:bold;}> svg{margin-right:30px;}'],
          function (e) {
            return e.theme.palette.white;
          }
        ),
        M = a.e.div.withConfig({ displayName: 'traclink-player__TracInfo', componentId: 'sc-4jg59k-5' })([
          'display:flex;width:calc(50% - 20px);display:flex;align-items:center;',
        ]),
        B = a.e.div.withConfig({ displayName: 'traclink-player__TracInfoContent', componentId: 'sc-4jg59k-6' })(
          [
            'color:',
