  ...
  [18],
  {
                    ...
                    switch ((n.prev = n.next)) {
                      case 0:
                        return (
                          (t = a.products),
                          (o = a.shippingAddress),
                          (r = { products: t, shippingAddress: o, orderType: 'NORMAL' }),
                          (n.next = 4),
                          fetch(''.concat(e.env.NEXT_PUBLIC_APP_API, '/merch/order/shipping-cost'), {
                            method: 'POST',
                      ...
                      case 7:
                        ...
                        return (n.next = 11), c.json();
                      case 11:
                        return (
                          (s = n.sent),
                          console.log('get shipping cost error: ', s.code, c.status),
                          n.abrupt('return', { error: { status: c.status, message: s.code } })
                        );
                      case 14:
                    ...
                    switch ((n.prev = n.next)) {
                      case 0:
                        return (
                          ...
                          (n.next = 4),
                          fetch(''.concat(e.env.NEXT_PUBLIC_APP_API, '/merch/merch-order'), {
                            method: 'POST',
                            body: JSON.stringify(d),
                          })
                        );
                      case 4:
                        return (s = n.sent), (n.next = 7), s.json();
                      case 7:
                        if (((u = n.sent), s.ok)) {
                          n.next = 14;
                          break;
                        }
                        return (n.next = 11), s.json();
                      case 11:
                        return (
                          (l = n.sent),
                          console.log('create merch order error: ', l.code, s.status),
                          n.abrupt('return', { error: { status: s.status, message: l.code } })
                        );
                      case 14:
    ...
    ifnz: function (e, n, a) {
      ...
      function C(e) {
        ...
        return w(
          'svg',
          Object(j.a)({ width: '16', height: '16', viewBox: '0 0 16 16' }, e),
          w('path', {
      ...
      var S,
            ...
            L(
              ...
              L(
                ...
                L(
                  B,
                  null,
                  L(I.a, { className: 'title-wrapper', alignItems: 'center' }, L(E, { className: 'title' }, e.title)),
              ...
              L(
                ...
                e.disabled
                  ...
                  : L(
                      ...
                      null,
                      e.active
                        ? L(_.a, { className: 'icon-check', iconSize: 24 })
                        : L(z, { className: 'icon-unselected', iconSize: 24 })
                    )
              )
            ),
        ...
        E = l.d.h2.withConfig({ displayName: 'checkbox__Title', componentId: 'e0jn5t-3' })(
      ...
      function U(e) {
                      ...
                      for (;;)
                        switch ((e.prev = e.next)) {
                          ...
                          case 5:
                            ...
                            break;
                          case 15:
                            (e.prev = 15), (e.t0 = e.catch(2)), console.log('get shipping cost error: ', e.t0), w(!1);
                          case 19:
                          case 'end':
                            return e.stop();
                        }
        ...
        Object(t.useEffect)(
          ...
          [_, A, T, U, re, se, me, fe, ve]
        ),
          Object(t.useEffect)(
            function () {
              h(!!(Me && Ce && (Ne || (cn && pn && gn && yn))));
            },
            [Me, Ce, Ne, cn, pn, gn, yn]
          );
                      ...
                      case 0:
                        ...
                        return (
                          ...
                          Object(y.a)({
                            ...
                            shippingMethod: Me,
                            shippingAddress: Ce,
                            shippingCost: Me === S.express ? xe.express : xe.standard,
                          })
                        );
                      case 4:
                        ...
                        return r(c), Object(k.c)('orderId', t), w(!1), e.abrupt('return', i.push('./secure-payment'));
                      case 12:
                      case 'end':
                        return e.stop();
                    }
        ...
        return q(
          V,
          {
            ...
            onSubmit: function (e) {
              e.preventDefault(),
                ...
                Ye(!me),
                nn(!fe),
                Ne || (wn(!cn), On(!gn), _n(!yn)),
                l && (w(!0), Pn());
            },
          },
          q(H, null, q(J, null, 'Please provide all required* fields to get shipping options.')),
          q(
            ee,
            null,
            q(
            ...
            q(
              ...
              q(
                ...
                q(O.a, {
                  label: 'City*',
                  value: re,
                  error: Ue ? 'Please add your City' : void 0,
                  onChange: function (e) {
                    return ce(e);
                  },
                  onFocus: function () {
          ...
          q(
            ...
            q(
              H,
              null,
              q(J, null, 'Shipping Options'),
              q(X, null, 'Shipping estimates do not include production time.')
            ),
            xe &&
              q(
                $,
                ...
                !!xe.standard &&
                  q(P, {
                    ...
                    hasIcons: q(ae, { active: Me === S.standard }, '$', Object(v.a)(xe.standard)),
                    active: Me === S.standard,
                    onClick: function () {
                      return ze(S.standard);
                    },
                  }),
                !!xe.express &&
                  q(P, {
                    ...
                    hasIcons: q(ae, { active: Me === S.express }, '$', Object(v.a)(xe.express)),
                    active: Me === S.express,
                    onClick: function () {
                      return ze(S.express);
                    },
            ...
            q(
              ...
              !Ne &&
                q(
                  Z,
                  null,
                  q(H, null, q(J, null, 'Billing Details')),
                  q(
                    $,
                    null,
                    q(O.a, {
          ...
          q(
            Q,
            { fullWidth: !0, type: 'submit', disabled: j },
            'Check Out',
            j
              ? q(R.a, { size: '100px', className: 'loading-animation '.concat(j ? 'is-loading' : ''), loading: j })
              : null
          )
        );
      }
      var V = l.d.form.withConfig({ displayName: 'billing__Billing', componentId: 'sc-1vjfge9-0' })(
        ...
        J = l.d.h1.withConfig({ displayName: 'billing__FormTitle', componentId: 'sc-1vjfge9-2' })(
        ...
        Q = Object(l.d)(x.a).withConfig({ displayName: 'billing__CartButton', componentId: 'sc-1vjfge9-5' })([
          'margin-top:40px;',
        ]),
