  ...
  [10],
  {
    ...
    '36NK': function (e, t, n) {
      ...
      function T(e) {
        ...
        Object(r.useEffect)(
          function () {
            return (
              (e = u) &&
                ((h.current = new _.Howl({ src: [e], html5: !0, autoplay: !1 })),
          ...
          n.videoUrl
            ...
            : k(
                ...
                k(
                  H,
                  null,
                  k(I, { src: n.coverUrl, alt: o, variant: 'square', noAnimation: !0 }),
                  c &&
                    n.tracks &&
                    n.tracks.length > 0 &&
                    k(C, { onClick: v }, k(x.a, null, d ? k(g, null) : k(m.a, { fill: p.palette.white })))
                ),
                k(
                  O,
                  null,
                  ...
                  k(
                    ...
                    !c &&
                      ...
                      k(
                        ...
                        d ? k(g, { hasPointer: !0 }) : k(m.a, { hasPointer: !0, fill: p.palette.white })
                      ),
      ...
      var S = a.d.div.withConfig({ displayName: 'traclink-info__InfoContainer', componentId: 'lff03t-0' })(
        ...
        I = Object(a.d)(w.a).withConfig({ displayName: 'traclink-info__StyledCoverImage', componentId: 'lff03t-1' })(
      ...
      function L(e) {
        ...
        return F(
          ...
          F(
            ...
            e.isPlaying ? F(E, { fill: t.colors.accent }) : null,
            e.isPlaying
              ? null
              : F(
                  q,
                  ...
                  F(m.a, { fill: t.colors.accent, hasPointer: !0 })
                )
          )
        );
      }
      var G = Object(a.d)(x.b.div).withConfig({
      ...
      function W(e) {
        return e.releasePlaylist.length
          ? R(
              X,
              { className: e.className },
              R(z, null, e.releasePlaylist.length, ' ', 1 === e.releasePlaylist.length ? 'Song' : 'Songs'),
      ...
      var X = Object(a.d)(x.b.div).withConfig({
          displayName: 'traclink-release__StyledTraclinkRelease',
          componentId: 'xnmvxw-0',
        })(['height:auto;width:100%;']),
        z = a.d.h2.withConfig({ displayName: 'traclink-release__SongsQty', componentId: 'xnmvxw-1' })(
      ...
      var Q = ['spotify', 'deezer', 'napster'],
        Z = ['custom', 'spotify', 'appleMusic', 'tidal', 'amazonMusic', 'youtube', 'deezer', 'pandora', 'napster'],
        K = !0;
      function J(e) {
        var t,
          n,
                    ...
                    f.length > 0
                      ? U(
                          ...
                          f
                            ...
                            .map(function (e, t) {
                              return U(s.a, { key: t, data: e, artistId: o.ownerId, releaseId: o.id, noAnimation: !0 });
                            })
                        )
                      : null,
                    U(W, {
