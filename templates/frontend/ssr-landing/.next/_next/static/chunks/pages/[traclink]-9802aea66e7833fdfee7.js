_N_E = (window.webpackJsonp_N_E = window.webpackJsonp_N_E || []).push([
  [14],
  {
    '36NK': function (e, n, t) {
      ...
      var M = Object(l.e)(v.b.div).withConfig({
        ...
        return j(
          ...
          j(
            ...
            j(
              W,
              null,
              j(D.a, { src: o.coverUrl, alt: o.title, variant: 'squareSmall' }),
              j(U, null, j('span', null, o.title), j('label', null, o.artistName))
            ),
            j(
              q,
              {
              ...
              j(_ ? E : B.a, { fill: A.palette.white })
            ),
          ...
          j(X, { progressbarWidth: b }, j('span', null))
        );
      }
      var V = l.e.div.withConfig({ displayName: 'traclink-player__PlayerContainer', componentId: 'sc-4jg59k-0' })(
        ...
        q = l.e.button.withConfig({ displayName: 'traclink-player__ActionButton', componentId: 'sc-4jg59k-3' })(
          [
        ...
        z = l.e.div.withConfig({ displayName: 'traclink-player__SongsInfo', componentId: 'sc-4jg59k-4' })(
      ...
      var ne = ['spotify', 'deezer', 'napster'],
        te = ['custom', 'spotify', 'appleMusic', 'tidal', 'amazonMusic', 'youtube', 'deezer', 'pandora', 'napster'],
        oe = !0;
      function re(e) {
        ...
        return (
                  ...
                  t = function (e) {
                    return e.platform
                      ? (function (e, n, t) {
                          ...
                          return ''.concat('https://api.trac.co', '/pre-save/').concat(e, '/?state=').concat(r);
                  ...
                  (function () {
                    ...
                    return s()
                      ? o
                          ...
                          .map(function (n) {
                            return ee(ee({}, n), {}, { url: t(n), isSuccess: e(n) });
                          })
                      : o.filter(function (e) {
          ...
          n && n.data
            ? K(
                a.a.Fragment,
                null,
                K(Y.a, null, K('link', { rel: 'icon', href: '/favicon/favicon.ico' })),
                K(i.a, {
                  ...
                  openGraph: {
                    title: ''.concat(n.data.artistName, ' | ').concat(n.title),
                    description: ''.concat(n.data.artistName, ' | ').concat(n.title),
                    url: 'https://'.concat(e.subdomain, '.').concat('trac.co', '/').concat(n.path),
                    images: [{ url: n.avatar }],
                    type: 'website',
                  },
                }),
                K(
                  ...
                  K(
                    ae,
                    null,
                    K(_, { data: n.data, isPreSave: s(), title: n.title }),
                    K(
                      ie,
                      { className: 'mt-60' },
                      o
                        ...
                        .map(function (e, n) {
                          return K(d.a, { key: n, data: e, className: 'mt-5' });
                        })
                    )
                  ),
                  n.data.tracks && n.data.tracks.length > 0 && K(G, { data: n.data, title: n.title })
                )
              )
            : null
        );
      }
      var ae = Object(l.e)(u.a).withConfig({ displayName: 'traclink__StyledContainer', componentId: 'sc-1fpre7y-0' })([
          'justify-content:center;flex-direction:column;margin-bottom:100px;',
        ]),
        ie = l.e.div.withConfig({ displayName: 'traclink__LinksContainer', componentId: 'sc-1fpre7y-1' })([
          'width:100%;',
        ]);
    },
    '3r9c': function (e, n) {
