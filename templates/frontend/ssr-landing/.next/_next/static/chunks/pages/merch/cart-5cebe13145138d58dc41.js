        ...
        return b(
          ...
          b(
            ...
            b(
              ...
              h.length
                ? b(c.a.Fragment, null, b(l.a, { cartKey: e.ownerId, onCartChanged: _ }), b(v.a, { subtotal: y }))
                : b(C, null, 'Cart is empty.'),
              h.length ? b(k, { onClick: N, disabled: I }, 'Proceed to Checkout') : null
            )
          )
        );
      }
                  ...
                  switch ((t.prev = t.next)) {
                    case 0:
                      return (
                        ...
                        (t.next = 4),
                        fetch(''.concat('https://api.staging.trac.co', '/merch/checkout'), {
                          method: 'POST',
        ...
        return u(
          ...
          u(c.a, {
            ...
            openGraph: {
              title: e.title,
              description: e.description || e.data.bio || e.title,
              url: 'https://'.concat(e.subdomain, '.').concat('staging.trac.co', '/'),
              images: [{ url: e.avatar }],
              type: 'website',
            },
          })
