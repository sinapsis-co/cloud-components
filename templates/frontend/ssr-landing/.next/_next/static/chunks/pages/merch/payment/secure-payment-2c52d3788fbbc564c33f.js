  ...
  [21],
  {
    bT4p: function (e, t, n) {
      ...
      var z = function (e) {
        ...
        D = x.d.div.withConfig({ displayName: 'stripe-handler__TitleWrapper', componentId: 'sc-16ke755-1' })([
      ...
      var V = x.d.div.withConfig({ displayName: 'shipping__ShippingInfoWrapper', componentId: 'cqn117-0' })([
        ...
        Q = x.d.div.withConfig({ displayName: 'shipping__ShippingInfoData', componentId: 'cqn117-3' })(
          [
            'background-color:',
        ...
        oe = Object(x.d)(function (e) {
          var t = e.className,
            ...
            O = y.shippingPrice,
            S = y.tax;
          console.log('Payment_order: ', c),
            console.log('Payment_products: ', j),
            o.a.useEffect(
              function () {
                if (!m && n && c && x) {
                  var e = w || {},
            ...
            ? re(
                ...
                (null === j || void 0 === j ? void 0 : j.length) &&
                  re(
                    ...
                    x && re('h1', { className: 'title' }, '$', Object(Z.a)(x))
                  ),
                re(
                  ie,
                  null,
                  ...
                  re(
                    R,
                    { error: l, onSuccess: E, customBtnLabel: x && 'Pay Now '.concat(Object(Z.a)(x)) },
                    re(K, {
                      products: j,
                      total: x,
                      shippingCost: Object(Z.a)(null !== O && void 0 !== O ? O : 0),
      ...
      function he(e) {
        ...
        return (
          console.log('SecurePayment_orderId: ', i),
    ...
    eWwy: function (e, t, n) {
      !(function (e, t) {
        ...
        var T = function (e) {
          ...
          V = R('p24Bank', D),
          X = R('epsBank', D),
          J = R('paymentRequestButton', D),
          Q = R('afterpayClearpayMessage', D);
