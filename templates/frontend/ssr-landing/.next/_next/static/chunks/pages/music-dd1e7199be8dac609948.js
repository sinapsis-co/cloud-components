  ...
  [17],
  {
    '5wV8': function (t, e, i) {
      ...
      function h(t) {
        ...
        return e ? l(u, Object(n.a)({ variant: a, src: e }, o)) : l(s, { variant: a, as: 'div' });
      }
      var u = c.d.img.withConfig({ displayName: 'cover-image__Cover', componentId: 'y910y5-0' })(
        ...
        s = Object(c.d)(u).withConfig({ displayName: 'cover-image__CoverColor', componentId: 'y910y5-1' })(
          ['background-color:', ';'],
          function (t) {
    ...
    HkQY: function (t, e, i) {
      ...
      var s = a.d.a.withConfig({ displayName: 'video-link__StyledVideoLink', componentId: 'sc-7idreb-0' })(
          [
    ...
    P1vn: function (t, e, i) {
      ...
      var f = !0;
      function v(t) {
        var e = Object(s.a)(t.siteData).pageData;
        return e && e.id
          ? d(
              a.a.Fragment,
              null,
    ...
    SL6b: function (t, e, i) {
      ...
      var s = a.d.a.withConfig({ displayName: 'song-link__StyledSongLink', componentId: 'sc-1wye2kl-0' })(
          [
            'display:flex;flex-direction:column;align-items:flex-start;gap:24px;@media (max-width:',
            '){gap:12px;}&.highlight{background-color:',
            ';grid-column:1/-1;order:-1;flex-direction:row;padding:32px;border-radius:5px;@media (max-width:',
        ...
        g = a.d.div.withConfig({ displayName: 'song-link__Info', componentId: 'sc-1wye2kl-3' })(
          [
            ...
            ';margin:0px;font-size:14px;font-weight:400;line-height:20px;opacity:0.7;}@media (max-width:',
            '){&.highlight{> h3,> p{text-align:center;white-space:pre-wrap;text-overflow:ellipsis;}}}',
          ],
          function (t) {
            return t.theme.colors.primary;
          },
    ...
    rJDM: function (t, e, i) {
      ...
      var n = i('q1tI'),
        ...
        s =
          ((e.a = function (t) {
            var e = t.className;
            return u(s, { className: e || '' }, u(h, null), u('h6', null, 'Featured'));
          }),
