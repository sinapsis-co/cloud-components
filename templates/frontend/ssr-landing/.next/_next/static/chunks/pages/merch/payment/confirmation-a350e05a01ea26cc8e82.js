_N_E = (window.webpackJsonp_N_E = window.webpackJsonp_N_E || []).push([
  [20],
  {
    ...
    E7Mf: function (t, n, e) {
      ...
      var m = Object(a.d)(p.a).withConfig({
        ...
        x = a.d.h4.withConfig({ displayName: 'payment-confirmation__Title', componentId: 'sc-1hvzzxz-2' })(
          ['color:', ';font-size:24px;font-weight:400;line-height:30px;margin:0;text-align:left;'],
          function (t) {
            return t.theme.colors.primary;
          }
        ),
        g = a.d.p.withConfig({ displayName: 'payment-confirmation__Description', componentId: 'sc-1hvzzxz-3' })(
          [
            'color:',
                ...
                y(
                  ...
                  y(
                    ...
                    y(
                      k,
                      null,
                      y('p', { className: 'redirecting' }, 'REDIRECTING YOU SHORTLY...'),
                      y('a', { href: '/' }, 'Continue to Artist Name')
                    )
                  )
                )
              )
      ...
      var k = a.d.div.withConfig({ displayName: 'confirmation__RedirectingContainer', componentId: 'sc-1rjhmep-0' })([
