    ...
    '0B8f': function (t, e, n) {
      ...
      function M(t) {
        var e,
          ...
          d = r.product,
          p = r.quantity,
          m = d.colors.find(function (t) {
            return 'White' == t.name || 'white' == t.name;
          }),
          h = d.colors[0].image || (null === (e = d.colors[0].images) || void 0 === e ? void 0 : e[0].src);
        return r
          ? D(
              F,
              { className: i },
              D(b.a, {
                ...
                jsxImage: D(W.a, {
                  ...
                  imageSrc:
                    (m || d).image ||
                    (null === (n = r.color) || void 0 === n || null === (o = n.images) || void 0 === o
                      ? void 0
                      : o[0].src) ||
                    h ||
                    '',
                ...
                D(
                  ...
                  s
                    ...
                    : D(
                        ...
                        D(P, { quantity: r.quantity, onChange: c }),
                        D(T, { className: 'price' }, '$', d.price.toFixed(2).toLocaleString()),
                        D(N, { onClick: l })
                      )
                ),
                s
