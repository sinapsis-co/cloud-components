  ...
  [21],
  {
    bT4p: function (e, t, n) {
      ...
      function me(e) {
        ...
        Object(r.useEffect)(
          function () {
            n.asPath !== n.route && console.log('useEffect_router.query: ', n.query);
          },
          [n]
        );
        var s = n.query.orderId;
        return null !== c && void 0 !== c && c.id
          ? le(
              o.a.Fragment,
              null,
              le(
                ...
                le(
                  ...
                  le(
                    ...
                    le(re, { orderId: Array.isArray(s) ? s[0] : s })
                  )
                )
              )
            )
