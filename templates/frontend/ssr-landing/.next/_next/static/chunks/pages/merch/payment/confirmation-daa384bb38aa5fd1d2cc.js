    ...
    E7Mf: function (t, n, e) {
      ...
      function d(t) {
        ...
        return f(
          ...
          { className: n },
          f(m, { iconSize: 32 }),
          f(x, null, 'Your order has been completed successfully.'),
          f(g, { className: 'has-marign' }, 'We\u2019ve sent you an e-mail containing all the details of your order.')
        );
      }
      var m = Object(r.d)(p.a).withConfig({
        ...
        x = r.d.h4.withConfig({ displayName: 'payment-confirmation__Title', componentId: 'sc-1hvzzxz-2' })(
          ['color:', ';font-size:24px;font-weight:400;line-height:30px;margin:0;text-align:left;'],
          function (t) {
            return t.theme.colors.primary;
          }
        ),
        g = r.d.p.withConfig({ displayName: 'payment-confirmation__Description', componentId: 'sc-1hvzzxz-3' })(
          [
            'color:',
                ...
                v(
                  ...
                  v(
                    ...
                    v(
                      N,
                      null,
                      v('p', { className: 'redirecting' }, 'REDIRECTING YOU SHORTLY...'),
                      v('a', { href: '/' }, 'Continue to Artist Name')
                    )
                  )
                )
              )
      ...
      var N = r.d.div.withConfig({ displayName: 'confirmation__RedirectingContainer', componentId: 'sc-1rjhmep-0' })([
