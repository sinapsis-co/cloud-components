_N_E = (window.webpackJsonp_N_E = window.webpackJsonp_N_E || []).push([
  [20],
  {
    '/kYb': function (e, t, n) {
      ...
      var d = Object(i.e)(l.b.div).withConfig({ displayName: 'back__IconWrapper', componentId: 'om8no8-0' })(
          ['cursor:pointer;width:40px;height:40px;&:hover{circle{fill:', ';}}'],
          function (e) {
            return e.theme.colors.itemBackgroundHover;
          }
        ),
        p = i.e.circle.withConfig({ displayName: 'back__StyledCircle', componentId: 'om8no8-1' })(
      ...
      var v = Object(i.e)(a.a).withConfig({
          displayName: 'back-navigation__NavigationContainer',
          componentId: 'kfmxgl-0',
        })(['max-height:40px;']),
        g = i.e.h6.withConfig({ displayName: 'back-navigation__Title', componentId: 'kfmxgl-1' })(
    ...
    '1LmX': function (e, t, n) {
      ...
      var _ = i.e.div.withConfig({ displayName: 'video-player__VideoWrapper', componentId: 'sc-19p591d-0' })([
        ...
        h = i.e.button.withConfig({ displayName: 'video-player__PlayButton', componentId: 'sc-19p591d-2' })(
          [
            'background-color:',
    ...
    '5wV8': function (e, t, n) {
      ...
      var s = u.e.img.withConfig({ displayName: 'cover-image__Cover', componentId: 'y910y5-0' })(
        ...
        d = Object(u.e)(s).withConfig({ displayName: 'cover-image__CoverColor', componentId: 'y910y5-1' })(
          ['background-color:', ';'],
          function (e) {
    ...
    FBxL: function (e, t, n) {
        ...
        var t = e.data,
          ...
          d = f(
            ...
            f(
              ...
              f(v, { className: t.platform ? '' : 'has-cover' }, f('h3', null, t.title))
            ),
            f(
              g,
              { className: 'icon' },
      ...
      var m = i.e.a.withConfig({ displayName: 'simple-link__Link', componentId: 'fqic60-0' })(
          [
        ...
        h = i.e.div.withConfig({ displayName: 'simple-link__Content', componentId: 'fqic60-1' })([
          'display:flex;align-items:center;justify-content:flex-start;width:100%;flex:0 1 auto;',
        ]),
        v = i.e.div.withConfig({ displayName: 'simple-link__Info', componentId: 'fqic60-2' })(
          [
        ...
        g = i.e.button.withConfig({ displayName: 'simple-link__Icon', componentId: 'fqic60-3' })(
          [
            'background-color:',
            ';display:flex;width:',
            ';height:',
        ...
        y = Object(i.e)(g).withConfig({ displayName: 'simple-link__PlatformIcon', componentId: 'fqic60-4' })(
    ...
    O8AL: function (e, t, n) {
            ...
            n.videoUrl
              ...
              : b(
                  ...
                  b(
                    T,
                    null,
                    b(I, null, b('h1', null, o), b('p', null, n.artistName)),
                    b(
                      S,
                      null,
                      !d &&
      ...
      var A = a.e.div.withConfig({ displayName: 'traclink-info__InfoContainer', componentId: 'lff03t-0' })(
          [
        ...
        k = Object(a.e)(y.a).withConfig({ displayName: 'traclink-info__StyledCoverImage', componentId: 'lff03t-1' })(
        ...
        T = a.e.div.withConfig({ displayName: 'traclink-info__Content', componentId: 'lff03t-2' })(
          [
            'min-height:',
        ...
        I = a.e.div.withConfig({ displayName: 'traclink-info__Info', componentId: 'lff03t-3' })(
          [
            'color:',
            ';@media (max-width:',
        ...
        S = a.e.div.withConfig({ displayName: 'traclink-info__PlayerInfo', componentId: 'lff03t-4' })(
          [
        ...
        O = a.e.button.withConfig({ displayName: 'traclink-info__ActionButton', componentId: 'lff03t-5' })(
          [
        ...
        j = a.e.div.withConfig({ displayName: 'traclink-info__SongsInfo', componentId: 'lff03t-6' })(
          [
        ...
        P = a.e.div.withConfig({ displayName: 'traclink-info__CoverWrapper', componentId: 'lff03t-7' })([
      ...
      function E(e) {
        ...
        return D(
          ...
          D(
            ...
            e.isPlaying ? null : D(V, { className: 'play-icon' }, D(m.a, { fill: t.colors.accent }))
          )
        );
      }
      var F = Object(a.e)(B.b.div).withConfig({
        ...
        z = a.e.div.withConfig({ displayName: 'traclink-release-item__SongName', componentId: 'p9uhcv-1' })(
          [
        ...
        V = a.e.div.withConfig({ displayName: 'traclink-release-item__IconWrapper', componentId: 'p9uhcv-2' })(
          [
      ...
      function G(e) {
        return e.releasePlaylist.length
          ? q(
              R,
              { className: e.className },
              q(W, null, e.releasePlaylist.length, ' ', 1 === e.releasePlaylist.length ? 'Song' : 'Songs'),
      ...
      var R = Object(a.e)(B.b.div).withConfig({
          displayName: 'traclink-release__StyledTraclinkRelease',
          componentId: 'xnmvxw-0',
        })(['height:auto;width:100%;']),
        W = a.e.h2.withConfig({ displayName: 'traclink-release__SongsQty', componentId: 'xnmvxw-1' })(
        ...
        return o && o.data
          ? X(
              ...
              X(
                ...
                X(
                  c.a,
                  { pageData: a, hasBackground: !0, hideNavbar: !0, hideCart: !0, action: X(N.a, null) },
                  X(
                    K,
                    null,
                    X(x, {
      ...
      var K = a.e.div.withConfig({ displayName: 'traclink__Wrapper', componentId: 'bjx3n0-0' })([
          'max-width:608px;margin:0 auto;',
        ]),
        ee = a.e.div.withConfig({ displayName: 'traclink__LinksContainer', componentId: 'bjx3n0-1' })([
          'width:100%;margin-top:48px;gap:14px;display:flex;flex-direction:column;',
        ]),
        te = a.e.div.withConfig({ displayName: 'traclink__MobileInfo', componentId: 'bjx3n0-2' })([
          'margin-top:32px;padding:0 24px;display:flex;flex-direction:column;justify-content:flex-start;align-items:center;gap:24px;',
        ]),
        ne = a.e.a.withConfig({ displayName: 'traclink__HomeButton', componentId: 'bjx3n0-3' })(
          [
            'background-color:',
            ';color:',
