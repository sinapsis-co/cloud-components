    ...
    RHGb: function (t, e, n) {
      ...
      function l(t) {
        ...
        return c(
          ...
          !i && c(d, { className: 'price' }, '$', n.price.toFixed(2).toLocaleString())
        );
      }
    ...
    baZN: function (t, e, n) {
        ...
        return j(
          ...
          r
            ? j(
                ...
                j(D, { sizeItems: v, helpText: '*All measurements are in Inches. All pieces fit true to size.' })
              )
            : null,
          j(
            L,
      ...
      function J(t) {
        var e = t.className,
          ...
          x = !(null === p || void 0 === p || !p.id || (i.colors.length && !h.id));
        return F(
          Z,
