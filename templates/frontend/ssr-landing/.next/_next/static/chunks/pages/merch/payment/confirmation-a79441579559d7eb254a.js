  ...
  [23],
  {
    '/kYb': function (n, t, e) {
      ...
      var m = Object(r.e)(s.b.div).withConfig({ displayName: 'back__IconWrapper', componentId: 'om8no8-0' })(
        ...
        p = Object(r.e)(s.b.path).withConfig({ displayName: 'back__StyledPath', componentId: 'om8no8-2' })(
          ['fill:', ';'],
          function (n) {
      ...
      var w = Object(r.e)(a.a).withConfig({
    ...
    E7Mf: function (n, t, e) {
      ...
      function p(n) {
        ...
        return d(
          ...
          { className: t },
          d(f, { iconSize: 64 }),
          d(g, null, 'Thank you for your order!'),
          d(w, null, 'Your order No:', i, ' has been placed.'),
          d(w, { className: 'has-marign' }, 'We sent an email to ', e, ' with your order confirmation and bill.', ' ')
        );
      }
      var f = Object(l.e)(m.a).withConfig({
        ...
        w = l.e.p.withConfig({ displayName: 'payment-confirmation__Description', componentId: 'sc-1hvzzxz-3' })(
          [
            'color:',
      ...
      function y() {
        ...
        Object(i.useEffect)(function () {
          var n = function (n) {
            var t, i, o;
            ((null === (t = 'https://app.trac.co') ? void 0 : t.split(',')) || []).includes(n.origin) &&
        ...
        return t && t.id
          ? v(
              ...
              v(
                ...
                v(p, { orderId: '1029482', userEmail: 'hernan@sinapsis.co' })
              )
            )
          : null;
      }
