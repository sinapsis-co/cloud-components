              ...
              if (n) {
                  ...
                  t = function (e) {
                    return e.platform
                      ? (function (e, n, t) {
                          ...
                          return ''.concat('https://api.staging.trac.co', '/pre-save/').concat(e, '/?state=').concat(r);
                ...
                u(
                  ...
                  analytics.track('Traclink Viewed', {
                    artist_name: n.data.artistName,
                    release_name: n.title,
                    artist_id: n.ownerId,
                    release_id: n.id,
                  });
              }
            ...
            ? re(
                ...
                re(i.a, {
                  ...
                  openGraph: {
                    title: ''.concat(n.data.artistName, ' | ').concat(n.title),
                    description: ''.concat(n.data.artistName, ' | ').concat(n.title),
                    url: 'https://'.concat(e.subdomain, '.').concat('staging.trac.co', '/').concat(n.path),
                    images: [{ url: n.avatar }],
                    type: 'website',
                  },
                }),
                  ...
                  re(
                    ...
                    re(
                      ...
                      o
                        ...
                        .map(function (e, t) {
                          return re(d.a, { key: t, data: e, className: 'mt-5', artistId: n.ownerId, releaseId: n.id });
                        })
                    )
                  ),
