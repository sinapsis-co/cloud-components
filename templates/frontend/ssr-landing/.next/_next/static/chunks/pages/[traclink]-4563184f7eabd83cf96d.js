          ...
          n.videoUrl
            ...
            : k(
                ...
                k(
                  H,
                  null,
                  k(S, { src: n.coverUrl, alt: o, variant: 'square' }),
                  s &&
                    n.tracks &&
                    n.tracks.length > 0 &&
                    ...
                    _.length > 0
                      ? Z(
                          ...
                          _.filter(function (e) {
                            ...
                            return Z(d.a, { key: t, data: e, artistId: o.ownerId, releaseId: o.id });
                          })
                        )
                      : null,
                    Z(W, {
    ...
    FBxL: function (e, t, n) {
      ...
      function b(e) {
        var t,
          ...
          _ = Object(i.e)(),
          b = Object(a.a)(),
          S = Object(g.a)({ triggerOnce: !0, rootMargin: '200px 0px' }),
          O = S.ref,
          P = S.inView,
          j = w(
            r.a.Fragment,
            ...
            n.highlight && b ? null : w(T, { className: 'icon' }, w(p, { height: '20px', fill: _.colors.primary }))
          ),
          C = ''
            .concat(o || '', ' ')
        ...
        return n.title && n.url
          ? w(
              x,
              {
                ...
                variants: y.e,
                initial: 'initial',
                animate: P || 0 === f ? 'animate' : 'initial',
                exit: 'exit',
                ref: O,
                transition: { duration: 0.35, delay: f ? 0.1 * f : 0, ease: [0.43, 0.13, 0.23, 0.96] },
              },
              w(A, { initial: 'rest', whileHover: 'hover', whileTap: 'tap', animate: 'rest', className: 'wrapper' }, j)
            )
          : null;
      }
