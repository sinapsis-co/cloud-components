  ...
  [20],
  {
    bT4p: function (e, t, n) {
      ...
      var m = n('jtTr'),
        ...
        k = x.d.span.withConfig({ displayName: 'button-loading__BtnText', componentId: 'sc-1tg7ajz-1' })(
      ...
      var T = function (e) {
        ...
        A = x.d.span.withConfig({ displayName: 'stripe-card-editor__StyledInputContainer', componentId: 'z24o1g-0' })(
          [
        ...
        L = Object(x.d)(function (e) {
                  ...
                  return y.a.wrap(function (e) {
                    for (;;)
                      switch ((e.prev = e.next)) {
                        case 0:
                          if ((t.preventDefault(), X && G)) {
                            e.next = 3;
                            break;
                          }
                          return e.abrupt('return');
                        case 3:
                          if ((r = G.getElement(i.CardNumberElement))) {
                            e.next = 6;
                            break;
                          }
                          return e.abrupt('return');
                        case 6:
                          return F(!0), n({ cardElement: r, fullName: D, zipCode: k }), e.abrupt('return', !1);
                        case 9:
                        case 'end':
                          return e.stop();
                      }
          ...
          return I(
            ...
            I(
              _,
              { className: 'mt-20', isLoading: W, disabled: !$, fullWidth: !0 },
        ...
        B = x.d.div.withConfig({ displayName: 'stripe-card-editor__PaymentDetails', componentId: 'z24o1g-2' })([
          'margin:16px 0;',
        ]),
        D = o.a.createElement,
        M = Object(x.d)(function (e) {
          var t = e.className,
            n = e.onSuccess,
            r = e.error,
            o = e.customBtnLabel,
          ...
          return D(
            'div',
            { className: t },
            D(q, null, D(R, null, 'Payment')),
            r && D('p', { className: 'mb-20 errorMsg' }, 'We had a problem while charging your card.'),
            D(
              L,
              {
                onStart: function () {
        ...
        R = x.d.h1.withConfig({ displayName: 'stripe-handler__Title', componentId: 'sc-16ke755-2' })(
      ...
      function U(e) {
        ...
        if (!t) return $(V, null, $(O.a, { size: '128px', loading: !0 }));
        var n = t.firstName,
          r = t.lastName,
          o = t.address1,
          i = t.country,
      ...
      var V = x.d.div.withConfig({ displayName: 'shipping__ShippingInfoWrapper', componentId: 'cqn117-0' })([
        ...
        G = x.d.h1.withConfig({ displayName: 'shipping__Title', componentId: 'cqn117-2' })(
        ...
        oe = Object(x.d)(function (e) {
          var t = e.className,
            ...
            c = Object(H.a)(n).order,
            s = o.a.useState(!1),
            l = Object(v.a)(s, 2),
            u = l[0],
            p = l[1],
            d = o.a.useState(Object(h.a)(Y.a)),
            f = Object(v.a)(d, 2),
            m = f[0],
            g = f[1],
            x = c || {},
          ...
          o.a.useEffect(
            function () {
              !m &&
                ...
                c &&
                w &&
                Object(F.a)({ totalCost: w, orderId: c.stripeOrderId })
                  .then(function (e) {
                    var t = null === e || void 0 === e ? void 0 : e.payment.payment_intent.client_secret;
                    t && (g(t), Object(h.c)('stripeClientSecret', t));
                  })
                  .catch(function (e) {
                  ...
                  for (;;)
                    switch ((e.prev = e.next)) {
                      case 0:
                        ...
                        return e.abrupt('return');
                      case 3:
                        return (e.next = 5), Object(Y.b)(a, m, t.cardElement);
                      case 5:
                        if (!(o = e.sent).error) {
                          e.next = 8;
                          break;
                      ...
                      case 8:
                        if ('succeeded' !== (null === o || void 0 === o ? void 0 : o.paymentIntent.status)) {
                          e.next = 13;
                          break;
                        }
                        return Object(h.b)(Y.a), (e.next = 12), r.push('./confirmation?orderId='.concat(n));
                      case 12:
                        return e.abrupt('return');
                      case 13:
                        return (
            ...
            ? re(
                ...
                (null === O || void 0 === O ? void 0 : O.length) &&
                  re(
                    ...
                    w && re('h1', { className: 'title' }, '$', Object(Q.a)(w))
                  ),
                re(
                  ae,
                  null,
                  re(U, { shippingAddress: j }),
                  re(
                    M,
                    { error: u, onSuccess: C, customBtnLabel: w && 'Pay Now $'.concat(Object(Q.a)(w)) },
                    re(K, {
                      products: O,
                      total: w,
                      shippingCost: Object(Q.a)(null !== E && void 0 !== E ? E : 0),
      ...
      var ge = x.d.div.withConfig({ displayName: 'secure-payment__ErrorContainer', componentId: 'sc-4qsbrg-0' })(
        [
