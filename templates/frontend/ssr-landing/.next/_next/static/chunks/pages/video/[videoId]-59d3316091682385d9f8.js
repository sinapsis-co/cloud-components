_N_E = (window.webpackJsonp_N_E = window.webpackJsonp_N_E || []).push([
  [21],
  {
    '/kYb': function (t, e, i) {
      ...
      var d = Object(o.e)(l.b.div).withConfig({ displayName: 'back__IconWrapper', componentId: 'om8no8-0' })(
        ...
        h = Object(o.e)(l.b.path).withConfig({ displayName: 'back__StyledPath', componentId: 'om8no8-2' })(
          ['fill:', ';'],
          function (t) {
      ...
      var v = Object(o.e)(a.a).withConfig({
        ...
        b = o.e.h6.withConfig({ displayName: 'back-navigation__Title', componentId: 'kfmxgl-1' })(
    ...
    '1LmX': function (t, e, i) {
      ...
      var m = o.e.div.withConfig({ displayName: 'video-player__VideoWrapper', componentId: 'sc-19p591d-0' })([
        ...
        f = o.e.div.withConfig({ displayName: 'video-player__ImageWrapper', componentId: 'sc-19p591d-1' })([
          'cursor:pointer;display:flex;justify-content:center;position:absolute;top:0;right:0;bottom:0;left:0;width:100%;height:100%;',
        ]),
        g = o.e.button.withConfig({ displayName: 'video-player__PlayButton', componentId: 'sc-19p591d-2' })(
          [
            'background-color:',
        ...
        v = Object(o.e)(function (t) {
          var e = Object(n.useState)(t.src),
            i = e[0],
            r = e[1],
            o = Object(n.useState)(t.src.length ? t.src[0] : ''),
            a = o[0],
            l = o[1];
          if (!t.src.length || !a || !i.length) return null;
          var s = function () {
              var t = i.slice(1);
              r(t), t.length && l(t[0]);
            },
          ...
          ['border-radius:5px;', ' ', ''],
          function (t) {
            return 'large' === t.variant && Object(o.d)(['object-fit:cover;width:100%;']);
          },
          function (t) {
            return 'small' === t.variant && Object(o.d)(['object-fit:cover;height:100%;width:100%;']);
          }
        );
    },
    '22w/': function (t, e, i) {
    ...
    '2JbC': function (t, e, i) {
                  ...
                  v(
                    ...
                    v(d.a, {
                      data: {
                        ...
                        id:
                          (null === r || void 0 === r || null === (i = r.embedData) || void 0 === i ? void 0 : i.id) ||
                          '',
      ...
      var k = a.e.div.withConfig({ displayName: 'videoId__Wrapper', componentId: 'sc-1a956zz-0' })([
          'max-width:608px;margin:0 auto;',
        ]),
        j = a.e.h3.withConfig({ displayName: 'videoId__MoreTitle', componentId: 'sc-1a956zz-1' })(
          [
        ...
        O = a.e.div.withConfig({ displayName: 'videoId__MobileInfo', componentId: 'sc-1a956zz-2' })([
          'margin-top:32px;padding:0 24px;display:flex;flex-direction:column;justify-content:flex-start;align-items:center;gap:24px;',
        ]),
        _ = a.e.a.withConfig({ displayName: 'videoId__HomeButton', componentId: 'sc-1a956zz-3' })(
          [
            'background-color:',
            ';color:',
    ...
    '5wV8': function (t, e, i) {
      ...
      function u(t) {
        ...
        return e ? l(s, Object(n.a)({ variant: o, src: e }, a)) : l(d, { variant: o, as: 'div' });
      }
      var s = c.e.img.withConfig({ displayName: 'cover-image__Cover', componentId: 'y910y5-0' })(
        ...
        d = Object(c.e)(s).withConfig({ displayName: 'cover-image__CoverColor', componentId: 'y910y5-1' })(
          ['background-color:', ';'],
          function (t) {
    ...
    HkQY: function (t, e, i) {
          ...
          ? u(
              ...
              u(
                ...
                u(
                  ...
                  { className: ''.concat(e.highlight ? 'highlight' : null) },
                  u('h3', null, e.title),
                  u('p', null, n, ', Star6ixse7en, MRG, Sweez')
                ),
      ...
      var d = o.e.a.withConfig({ displayName: 'video-link__StyledVideoLink', componentId: 'sc-7idreb-0' })(
          [
        ...
        p = o.e.div.withConfig({ displayName: 'video-link__WrapperImage', componentId: 'sc-7idreb-1' })(
          [
        ...
        h = o.e.div.withConfig({ displayName: 'video-link__WrapperInfo', componentId: 'sc-7idreb-2' })(
          ['display:flex;flex-direction:column;justify-content:space-between;align-items:flex-start;height:100%;', ''],
          function (t) {
            return (
              t.highlight &&
              Object(o.d)(['@media (max-width:', '){align-items:center;gap:24px;}'], function (t) {
                var e = t.theme;
                return ''.concat(e.breakpoints.laptop, 'px');
              })
            );
        ...
        m = o.e.div.withConfig({ displayName: 'video-link__Info', componentId: 'sc-7idreb-3' })(
          [
        ...
        f = o.e.div.withConfig({ displayName: 'video-link__Play', componentId: 'sc-7idreb-4' })(
          [
            'background-color:',
    ...
    'M/EI': function (t, e, i) {
      ...
      var n = i('q1tI'),
        ...
        o = i('vOnD'),
        a = r.a.createElement,
        c = o.e.div.withConfig({ displayName: 'grid__StyledGrid', componentId: 'sc-1mu4cgu-0' })(
          [
    ...
    rJDM: function (t, e, i) {
      ...
      var n = i('q1tI'),
        ...
        d =
          ...
          o.e.div.withConfig({ displayName: 'featured-badge__StyledBadge', componentId: 'sc-69krp2-0' })(
            [
              'background-color:',
