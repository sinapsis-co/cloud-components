  ...
  [18],
  {
    ...
    QeBL: function (t, e, n) {
      ...
      var N = a.e.div.withConfig({ displayName: 'newsletter__NewsletterMobile', componentId: 'qzsd7i-0' })([
        ...
        D = a.e.div.withConfig({ displayName: 'newsletter__ModalContent', componentId: 'qzsd7i-5' })(
          ['padding-bottom:34px;text-align:center;> h2{font-weight:800;font-size:32px;color:', ';text-align:center;}'],
          function (t) {
            return t.theme.colors.primary;
          }
        ),
        q = a.e.input.withConfig({ displayName: 'newsletter__MobileInput', componentId: 'qzsd7i-6' })(
          [
        ...
        Object(r.useEffect)(function () {
          ...
          window.analytics &&
            window.analytics.track('Tracpage Viewed', {
              ...
              releases: null === n || void 0 === n || null === (t = n.links) || void 0 === t ? void 0 : t.length,
              social_links:
                null === n ||
                void 0 === n ||
                null === (e = n.data) ||
                  ...
                  t
                    ...
                    .forEach(function (t) {
                      5 ===
                        ...
                        r.push(rt(rt({}, t), {}, { order: r.length }));
                    }),
                (null === (e = r) || void 0 === e ? void 0 : e.length) > 0 && i.push(r),
                i
              );
            },
            [n]
                ...
                nt(
                  ...
                  nt(
                    ...
                    nt(
                      ...
                      n.data.social
                        ...
                        .map(function (t) {
                          return t.url && nt(A, { href: t.url, key: t.url }, Object(u.a)(t.provider));
                        })
                    )
                  ),
                  t.merchData.length
                  ...
                  c.map(function (t) {
                    return t.map(function (e) {
                      ...
                      return !1 === e.show
                        ? null
                        : ((u = null !== (i = e.start) && void 0 !== i ? i : ''),
                          (s = null !== (r = e.end) && void 0 !== r ? r : ''),
                          '' === u ||
                          '' === s ||
                          (et()(new Date()).isAfter(new Date(u)) && et()(new Date()).isBefore(new Date(s)))
                            ? 'embed' === e.type
                              ? nt(Z.a, {
                                  ...
                                  data: {
                                    title: e.title,
                                    url: null === (o = e.embedData) || void 0 === o ? void 0 : o.url,
                                    id: (null === (c = e.embedData) || void 0 === c ? void 0 : c.id) || '',
                                    type: e.type,
                                  },
                                  artistName: n.title,
                                  key: null === (l = e.embedData) || void 0 === l ? void 0 : l.url,
                                })
                              : 'header' === e.type
                              ? nt(ct, { key: e.title }, nt('span', null, e.title))
                              : 'traclink' === e.type
                              ? nt(G, {
                                  data: e,
                                  key: e.order,
