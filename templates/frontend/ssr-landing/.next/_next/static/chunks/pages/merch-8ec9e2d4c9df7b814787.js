        ...
        return (
          ...
          e && e.id
            ? p(
                ...
                null,
                p(c.a, { pageData: e }),
                p(l.a, { theme: e ? e.theme : void 0 }, p(o.a, { pageData: e }, p(m, { products: t.merchData })))
              )
            : null
        );
      }
    ...
    RHGb: function (t, e, n) {
      ...
      function l(t) {
        ...
        return c(
          ...
          !l && c(s, { className: 'price' }, '$', n.price.toFixed(2).toLocaleString())
        );
      }
    ...
    aagu: function (t, e, n) {
      ...
      function c(t) {
        ...
        return o(
          ...
          r
            ? o(u, { className: ''.concat(m ? 'cart' : '', ' ').concat(p ? 'detail' : '') }, o(d, null, c))
            : o(s, { src: n, alt: i })
        );
      }
    ...
    xQzR: function (t, e, n) {
      ...
      function s(t) {
        ...
        return d(
          ...
          d(l.a, { className: 'product-info', product: n })
        );
      }
