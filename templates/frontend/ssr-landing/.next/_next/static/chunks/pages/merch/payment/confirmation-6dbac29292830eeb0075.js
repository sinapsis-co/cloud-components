_N_E = (window.webpackJsonp_N_E = window.webpackJsonp_N_E || []).push([
  [23],
  {
    '/kYb': function (n, t, e) {
      ...
      var m = Object(r.e)(l.b.div).withConfig({ displayName: 'back__IconWrapper', componentId: 'om8no8-0' })(
    ...
    E7Mf: function (n, t, e) {
      ...
      var f = Object(s.e)(m.a).withConfig({
        ...
        g = s.e.h4.withConfig({ displayName: 'payment-confirmation__Title', componentId: 'sc-1hvzzxz-2' })(
          ['color:', ';font-size:24px;font-weight:400;line-height:28px;margin:0;text-align:center;'],
          function (n) {
            return n.theme.colors.primary;
          }
        ),
        v = s.e.p.withConfig({ displayName: 'payment-confirmation__Description', componentId: 'sc-1hvzzxz-3' })(
          [
            'color:',
