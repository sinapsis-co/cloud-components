  ...
  [16],
  {
    '0B8f': function (t, e, n) {
      ...
      var S = a.d.svg.withConfig({ displayName: 'quantity__QuantitySvg', componentId: 'sc-1spopsv-0' })(
        ...
        E = a.d.path.withConfig({ displayName: 'quantity__QuantityPath', componentId: 'sc-1spopsv-1' })(
      ...
      var B = Object(a.d)(j.a).withConfig({
          displayName: 'product-quantity-selector__QuantityWrapper',
          componentId: 'sc-9xduq-0',
        })(['justify-content:flex-start;align-items:center;']),
        z = a.d.h6.withConfig({ displayName: 'product-quantity-selector__QuantityText', componentId: 'sc-9xduq-1' })(
          [
                ...
                W(
                  ...
                  l
                    ...
                    : W(
                        ...
                        W(P, { quantity: o.quantity, onChange: r }),
                        W(H, { className: 'price' }, '$', u.price.toFixed(2).toLocaleString()),
                        W(N, { onClick: a })
                      )
                ),
                l
      ...
      var F = a.d.div.withConfig({ displayName: 'product-cart-item__ProductContainer', componentId: 'sc-1tvca32-0' })(
        ...
        T = a.d.p.withConfig({ displayName: 'product-cart-item__QuantityNumber', componentId: 'sc-1tvca32-3' })(
          ['font-size:16px;font-weight:400;color:', ';width:100%;width:fill-available;text-align:right;'],
          function (t) {
            return t.theme.colors.secondary;
          }
        ),
        H = a.d.h6.withConfig({ displayName: 'product-cart-item__Price', componentId: 'sc-1tvca32-4' })(
          ['color:', ';font-size:16px;font-weight:400;line-height:24px;opacity:0.7;margin:0;'],
          function (t) {
            return t.theme.colors.primary;
          }
        ),
        A = a.d.div.withConfig({ displayName: 'product-cart-item__MobileContainer', componentId: 'sc-1tvca32-5' })(
          [
      ...
      var Z = a.d.div.withConfig({ displayName: 'product-cart-list__CartList', componentId: 'h81uri-0' })([
              ...
              U(
                ...
                U(
                  ...
                  c && c.length
                    ...
                    : U(nt, null, U(l.a, { className: 'cart-icon' }), U(ot, null, 'Your cart is empty'))
                )
              )
            )
          : null;
