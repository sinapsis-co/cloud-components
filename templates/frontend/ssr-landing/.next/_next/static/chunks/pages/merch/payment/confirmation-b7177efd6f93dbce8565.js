_N_E = (window.webpackJsonp_N_E = window.webpackJsonp_N_E || []).push([
  [17],
  {
    '/kYb': function (t, n, e) {
      ...
      var p = Object(o.e)(l.b.div).withConfig({ displayName: 'back__IconWrapper', componentId: 'om8no8-0' })(
      ...
      function g(t) {
        ...
        return d(
          ...
          e || n ? d(w, null, e || n) : null
        );
      }
      var x = Object(o.e)(r.a).withConfig({
          displayName: 'back-navigation__NavigationContainer',
          componentId: 'kfmxgl-0',
        })(['max-height:40px;']),
        w = o.e.h6.withConfig({ displayName: 'back-navigation__Title', componentId: 'kfmxgl-1' })(
    ...
    E7Mf: function (t, n, e) {
      ...
      var d = Object(u.e)(m.a).withConfig({
        ...
        x = u.e.h4.withConfig({ displayName: 'payment-confirmation__Title', componentId: 'sc-1hvzzxz-2' })(
          ['color:', ';font-size:24px;font-weight:400;line-height:28px;margin:0;text-align:center;'],
          function (t) {
            return t.theme.colors.primary;
          }
        ),
        w = u.e.p.withConfig({ displayName: 'payment-confirmation__Description', componentId: 'sc-1hvzzxz-3' })(
          [
            'color:',
          ...
          ? v(
              ...
              v(
                ...
                v(
                  ...
                  v(f, { orderId: '1029482', userEmail: 'hernan@sinapsis.co' })
                )
              )
            )
          : null;
