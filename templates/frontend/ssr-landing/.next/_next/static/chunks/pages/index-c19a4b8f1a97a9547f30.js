    ...
    QeBL: function (t, e, n) {
      ...
      function F(t) {
        ...
        return V(
          T,
          { className: n },
          V(M.a, { variant: 'rounded', alt: ''.concat(i, '-img'), src: e }),
          V('h1', null, i),
          r && V('span', null, r)
        );
      }
      ...
      function G(t) {
        ...
        return e.title && e.url
          ? X(
              ...
              X(M.a, { src: e.avatar, alt: e.title }),
              X(
                $,
          ...
          ? nt(
              ...
              nt(l.a, {
                ...
                openGraph: {
                  title: n.title,
                  description: n.description || n.data.bio || n.title,
                  url: 'https://'.concat(n.subdomain, '.').concat('trac-dev.sinapsis.co', '/'),
                  images: [{ url: n.avatar }],
                  type: 'website',
                },
              }),
                        ...
                        : ((u = null !== (r = e.start) && void 0 !== r ? r : ''),
                          ...
                          (et()(new Date()).isAfter(new Date(u)) && et()(new Date()).isBefore(new Date(s)))
                            ? 'embed' === e.type
                              ...
                              : 'header' === e.type
                              ? nt(ct, null, nt('span', null, 'Header'))
                              : 'traclink' === e.type
                              ? nt(G, {
                                  data: e,
                                  key: i,
