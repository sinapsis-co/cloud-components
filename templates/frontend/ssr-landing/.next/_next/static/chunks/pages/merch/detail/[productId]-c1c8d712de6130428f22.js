_N_E = (window.webpackJsonp_N_E = window.webpackJsonp_N_E || []).push([
  [17],
  {
    '/kYb': function (t, e, n) {
      ...
      var b = Object(a.d)(r.a).withConfig({
    ...
    baZN: function (t, e, n) {
      ...
      function M(t) {
        ...
        return X(
          A,
          Object(D.a)({ width: '16', height: '16', viewBox: '0 0 16 16' }, e, { onClick: n }),
      ...
      var A = p.d.svg.withConfig({ displayName: 'question-mark__QuestionMark', componentId: 'sc-130dwmn-0' })([
          'cursor:pointer;',
        ]),
        H = i.createElement;
      function R(t) {
      ...
      var P = p.d.div.withConfig({ displayName: 'tooltip__TooltipWrapper', componentId: 'sc-1ha8c9q-0' })([
        ...
        F = p.d.div.withConfig({ displayName: 'tooltip__TextWrapper', componentId: 'sc-1ha8c9q-1' })([
          'display:flex;justify-content:flex-start;align-items:center;gap:5px;',
        ]),
        G = p.d.span.withConfig({ displayName: 'tooltip__TooltipText', componentId: 'sc-1ha8c9q-2' })(
          [
      ...
      function st(t) {
        ...
        f ? (o.image = f.image || o.image) : h && (o.image = h || o.image);
        var g = Object(i.useState)(f || o.colors[0]),
          b = g[0],
          v = g[1],
          x = Object(i.useState)(),
          y = x[0],
          w = x[1],
          C = !(!s || !y || (o.colors.length && !b.id)),
          I = a.find(function (t) {
          ...
          dt(
            ...
            dt(
              ...
              dt(O.a, {
                ...
                isJsx: !0,
                jsxImage: dt(lt.a, {
                  fill: (null === b || void 0 === b ? void 0 : b.color) || 'white',
              ...
              ? dt(
                  ...
                  o.colors.map(function (t, e) {
                    return dt(
                      ...
                      t.id == b.id ? dt(k, { fill: 'white' }) : dt(k, { fill: 'grey' })
                    );
                  })
                )
              : null
