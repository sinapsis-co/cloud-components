_N_E = (window.webpackJsonp_N_E = window.webpackJsonp_N_E || []).push([
  [24],
  {
    ...
    bT4p: function (t, e, n) {
      ...
      function p(t) {
        var e,
          n = new RegExp('^([^.]+)(?:.[^.]+){0,1}.'.concat('staging.trac.co', '$')),
              ...
              for (;;)
                switch ((t.prev = t.next)) {
                  case 0:
                    return (
                      (n = p(e)),
                      (r = ''.concat('https://media.staging.trac.co', '/trac-page/').concat(n, '/data.json')),
                      t.abrupt(
                        'return',
      ...
      function V() {
        ...
        Object(r.useEffect)(function () {
          var t = function (t) {
            var e, r, o;
            (
              (null === (e = 'http://localhost:3000,https://app.staging.trac.co') ? void 0 : e.split(',')) || []
            ).includes(t.origin) &&
