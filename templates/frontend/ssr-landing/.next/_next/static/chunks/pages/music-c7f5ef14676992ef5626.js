  ...
  [19],
  {
    '5wV8': function (t, e, i) {
      ...
      var s = c.e.img.withConfig({ displayName: 'cover-image__Cover', componentId: 'y910y5-0' })(
        ...
        u = Object(c.e)(s).withConfig({ displayName: 'cover-image__CoverColor', componentId: 'y910y5-1' })(
          ['background-color:', ';'],
          function (t) {
    ...
    HkQY: function (t, e, i) {
      ...
      var u = a.e.a.withConfig({ displayName: 'video-link__StyledVideoLink', componentId: 'sc-7idreb-0' })(
          [
        ...
        p = a.e.div.withConfig({ displayName: 'video-link__WrapperImage', componentId: 'sc-7idreb-1' })(
          [
        ...
        d = a.e.div.withConfig({ displayName: 'video-link__WrapperInfo', componentId: 'sc-7idreb-2' })(
          ['display:flex;flex-direction:column;justify-content:space-between;align-items:flex-start;height:100%;', ''],
          function (t) {
            return (
              t.highlight &&
              Object(a.d)(['@media (max-width:', '){align-items:center;gap:24px;}'], function (t) {
                var e = t.theme;
                return ''.concat(e.breakpoints.laptop, 'px');
              })
            );
        ...
        g = a.e.div.withConfig({ displayName: 'video-link__Info', componentId: 'sc-7idreb-3' })(
          [
        ...
        m = a.e.div.withConfig({ displayName: 'video-link__Play', componentId: 'sc-7idreb-4' })(
          [
            'background-color:',
    ...
    'M/EI': function (t, e, i) {
      ...
      var n = i('q1tI'),
        ...
        a = i('vOnD'),
        o = r.a.createElement,
        c = a.e.div.withConfig({ displayName: 'grid__StyledGrid', componentId: 'sc-1mu4cgu-0' })(
          [
    ...
    SL6b: function (t, e, i) {
      ...
      var u = a.e.a.withConfig({ displayName: 'song-link__StyledSongLink', componentId: 'sc-1wye2kl-0' })(
        ...
        p = a.e.div.withConfig({ displayName: 'song-link__WrapperImage', componentId: 'sc-1wye2kl-1' })(
          [
            'padding:32px;border-radius:5px;background-color:',
            ';margin-bottom:24px;position:relative;@media (max-width:',
            '){display:flex;justify-content:center;align-items:center;padding:0;}&.highlight{height:',
        ...
        d = a.e.div.withConfig({ displayName: 'song-link__WrapperInfo', componentId: 'sc-1wye2kl-2' })(
          ['display:flex;flex-direction:column;justify-content:space-between;align-items:flex-start;height:100%;', ''],
          function (t) {
            return (
              t.highlight &&
        ...
        g = a.e.div.withConfig({ displayName: 'song-link__Info', componentId: 'sc-1wye2kl-3' })(
          [
            'text-align:left;> h3{margin:0px;color:',
            ';font-size:16px;font-weight:700;line-height:24px;display:-webkit-box;-webkit-line-clamp:2;-webkit-box-orient:vertical;overflow:hidden;}> p{color:',
            ';margin:0px;font-size:14px;font-weight:400;line-height:20px;opacity:0.7;}@media (max-width:',
        ...
        m = a.e.div.withConfig({ displayName: 'song-link__Play', componentId: 'sc-1wye2kl-4' })(
          [
            'background-color:',
            ';position:absolute;top:50%;left:50%;transform:translate(-50%,-50%);display:flex;justify-content:center;align-items:center;width:44px;height:44px;border-radius:50%;cursor:pointer;opacity:0;padding:0;overflow:hidden;transition:opacity ',
            ';> svg{fill:',
    ...
    rJDM: function (t, e, i) {
      ...
      var n = i('q1tI'),
        ...
        u =
          ...
          a.e.div.withConfig({ displayName: 'featured-badge__StyledBadge', componentId: 'sc-69krp2-0' })(
            [
              'background-color:',
