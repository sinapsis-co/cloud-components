_N_E = (window.webpackJsonp_N_E = window.webpackJsonp_N_E || []).push([
  [18],
  {
    ...
    '0FW9': function (t, e, n) {
      ...
      function m(t) {
        ...
        return p(
          d,
          {
            className: e,
            onClick: function () {
              return a.push('/merch/detail/'.concat(n.id));
            },
          },
      ...
      var d = r.e.div.withConfig({ displayName: 'product-item__ProductContainer', componentId: 'sc-1rx8y8s-0' })(
          [
      ...
      function h(t) {
        ...
        return f(
          ...
          f(
            ...
            null,
            r.map(function (t, e) {
              return f(m, { className: 'product-item', key: ''.concat(t.title, '-').concat(e), product: t, inList: 2 });
            })
          ),
          n
            ? null
    ...
    aagu: function (t, e, n) {
      ...
      function c(t) {
        var e = t.className,
          ...
          a = t.square,
          r = t.alt;
        return o(u, { className: e, inList: i, square: a }, o(l, { src: n, alt: r }));
      }
