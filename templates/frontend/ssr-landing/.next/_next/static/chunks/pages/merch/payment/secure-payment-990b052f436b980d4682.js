_N_E = (window.webpackJsonp_N_E = window.webpackJsonp_N_E || []).push([
  [20],
  {
    bT4p: function (e, t, n) {
                  ...
                  for (;;)
                    switch ((e.prev = e.next)) {
                      case 0:
                        ...
                        return e.abrupt('return');
                      case 3:
                        return (e.next = 5), Object(H.b)(a, m, t.cardElement);
                      case 5:
                        if (!(o = e.sent).error) {
                          e.next = 8;
                          break;
                      ...
                      case 8:
                        ...
                        return Object(h.b)(H.a), (e.next = 12), r.push('./confirmation?orderId='.concat(n));
                      case 12:
                        return e.abrupt('return');
                      case 13:
                        return (
              ...
              ue(
                ...
                ue(
                  ...
                  ue(
                    ...
                    a
                      ? ue(re, { orderId: Array.isArray(a) ? a[0] : a })
                      : ue(
                          he,
                          null,
                          ue('p', { className: 'redirecting' }, 'Something went wrong...'),
                          ue('a', { href: '/merch/payment/billing' }, 'Go to a previous page')
                        )
                  )
                )
              )
      ...
      var he = x.d.div.withConfig({ displayName: 'secure-payment__ErrorContainer', componentId: 'sc-4qsbrg-0' })(
        [
