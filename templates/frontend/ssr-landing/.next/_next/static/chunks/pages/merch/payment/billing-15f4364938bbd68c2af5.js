  ...
  [19],
  {
    ...
    ifnz: function (e, n, a) {
            ...
            P(
              ...
              P(
                ...
                P(
                  E,
                  null,
                  P(z.a, { className: 'title-wrapper', alignItems: 'center' }, P(F, { className: 'title' }, e.title)),
              ...
              P(
                ...
                e.disabled
                  ...
                  : P(
                      ...
                      null,
                      e.active
                        ? P(M.a, { className: 'icon-check', iconSize: 24 })
      ...
      function V(e) {
                    ...
                    case 0:
                      ...
                      return (
                        ...
                        x({
                          ...
                          shippingMethod: Me,
                          shippingAddress: Ce,
                          shippingCost: Me === O.express ? ke.express : ke.standard,
                        })
                      );
                    case 4:
                      ...
                      return (
                        r(c),
                        C(!1),
                        Object(k.b)('orderId', t),
                        e.abrupt('return', i.push('./secure-payment?orderId='.concat(t)))
                      );
                    case 12:
                    case 'end':
                      return e.stop();
        ...
        return q(
          ...
          q(
            ...
            q(
              ...
              q(
                ...
                q(
                  W,
                  { title: 'Country*', hasFilter: !0, filterLabel: 'Search Country', value: T.name },
                  G.map(function (e) {
                    return q(
                      I.a,
                      {
              ...
              q(
                ...
                !!ke.standard &&
                  q(B, {
                    ...
                    hasIcons: q(ae, { active: Me === O.standard }, '$', Object(v.a)(ke.standard)),
                    active: Me === O.standard,
                    onClick: function () {
                ...
                !!ke.express &&
                  q(B, {
                    ...
                    hasIcons: q(ae, { active: Me === O.express }, '$', Object(v.a)(ke.express)),
                    active: Me === O.express,
                    onClick: function () {
                      return _e(O.express);
                    },
          ...
          q(
            ...
            'Check Out',
            j
              ? q(D.a, { size: '100px', className: 'loading-animation '.concat(j ? 'is-loading' : ''), loading: j })
              : null
          )
        );
      }
      var J = l.d.form.withConfig({ displayName: 'billing__Billing', componentId: 'sc-1vjfge9-0' })(
        ...
        Q = Object(l.d)(w.a).withConfig({ displayName: 'billing__CartButton', componentId: 'sc-1vjfge9-5' })([
          'margin-top:40px;',
        ]),
