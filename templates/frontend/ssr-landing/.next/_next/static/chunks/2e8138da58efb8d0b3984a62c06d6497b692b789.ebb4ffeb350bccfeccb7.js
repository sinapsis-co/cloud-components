  ...
  [9],
  {
    '1LmX': function (t, e, i) {
      ...
      function f(t) {
        var e,
          ...
          g = null === (e = r.url) || void 0 === e ? void 0 : e.includes('list=');
        return d(
          p,
          { className: i },
          s
      ...
      var p = l.e.div.withConfig({ displayName: 'video-player__VideoWrapper', componentId: 'sc-19p591d-0' })([
        ...
        m = l.e.button.withConfig({ displayName: 'video-player__PlayButton', componentId: 'sc-19p591d-2' })(
          [
            'background-color:',
    ...
    '5wV8': function (t, e, i) {
      ...
      function u(t) {
        ...
        return e ? o(s, Object(n.a)({ variant: c, src: e }, l)) : o(h, { variant: c, as: 'div' });
      }
      var s = a.e.img.withConfig({ displayName: 'cover-image__Cover', componentId: 'y910y5-0' })(
        ...
        h = Object(a.e)(s).withConfig({ displayName: 'cover-image__CoverColor', componentId: 'y910y5-1' })(
          ['background-color:', ';'],
          function (t) {
    ...
    FBxL: function (t, e, i) {
      ...
      function p(t) {
        var e = t.data,
          ...
          w = f(
            ...
            f(m, { variant: s }, f('h3', null, e.title)),
            'row' === s &&
              f(
                v,
                null,
                e.isSuccess
                  ? f(h, { height: '20px', fill: p.colors.success })
                  : f(u, { height: '20px', fill: p.colors.primary })
              )
          );
        return e.title && e.url
          ? f(
              C,
              {
                ...
                target: '_blank',
                onClick: function () {
                  analytics.track('Traclink Click', { dsp: e.platform, artist_id: n, release_id: a });
                },
              },
              w
            )
      ...
      var C = d.e.a.withConfig({ displayName: 'simple-link__Link', componentId: 'fqic60-0' })(
        ...
        m = d.e.div.withConfig({ displayName: 'simple-link__Info', componentId: 'fqic60-1' })(
          [
        ...
        v = d.e.button.withConfig({ displayName: 'simple-link__Icon', componentId: 'fqic60-2' })(
          [
            'background-color:',
            ';display:flex;width:',
            ';height:',
        ...
        g = Object(d.e)(v).withConfig({ displayName: 'simple-link__PlatformIcon', componentId: 'fqic60-3' })(
      ...
      var y = n.createElement,
        z = function (t) {
          return y(
            ...
            y('rect', { y: '12', width: '5', height: '3' }),
            y('rect', { x: '12', y: '12', width: '5', height: '3' }),
            y('rect', { x: '12', y: '8', width: '5', height: '3' }),
            y('rect', { x: '6', y: '12', width: '5', height: '3' }),
            y('rect', { x: '6', y: '8', width: '5', height: '3' }),
            y('rect', { x: '6', y: '4', width: '5', height: '3' }),
            y('rect', { x: '18', y: '12', width: '5', height: '3' }),
            y('rect', { x: '18', y: '8', width: '5', height: '3' }),
            y('rect', { x: '18', width: '5', height: '3' }),
            y('rect', { x: '18', y: '4', width: '5', height: '3' })
          );
        },
        M = n.createElement,
        j = function (t) {
        ...
        H = function (t) {
          return B(
            ...
            B('rect', { fill: t.fill, x: '17.7', y: '2.3', width: '1.1', height: '5.3' }),
            B('ellipse', { fill: t.fill, cx: '18.2', cy: '0.8', rx: '0.7', ry: '0.8' })
          );
        },
        N = n.createElement,
        q = function (t) {
