                  ...
                  this.scrollToHash(),
                    N.isSsr &&
                      ...
                      N.replace(
                        N.pathname +
                          '?' +
                          String(g.assign(g.urlQueryToSearchParams(N.query), new URLSearchParams(location.search))),
                        q,
                  ...
                  switch ((e.prev = e.next)) {
                    case 0:
                      return (
                        ...
                        D.scriptLoader && ((a = r(7829)), (0, a.initScriptLoader)(D.scriptLoader)),
        ...
        function e(t, r, n, o) {
          ...
          i(this, e),
            ...
            (this.onPopState = function (e) {
              ...
              if (t) {
                if (t.__N) {
                  ...
                  (a.isSsr && n === A(a.asPath) && u === A(a.pathname)) ||
                    ...
                    a.change(
                      ...
                      r,
                      n,
                      Object.assign({}, o, { shallow: o.shallow && a._shallow, locale: o.locale || a.defaultLocale }),
                      undefined
                    );
                }
              } else {
                var c = a.pathname,
                  s = a.query;
                a.changeState('replaceState', O.formatWithValidation({ pathname: A(c), query: s }), g.getURL());
              }
            });
          ...
          if (
            ...
            (S._shouldResolveHref = n !== t),
              this.changeState('replaceState', O.formatWithValidation({ pathname: A(t), query: r }), g.getURL(), S);
          }
                      ...
                      function (t) {
                        for (;;)
                          switch ((t.prev = t.next)) {
                            ...
                            case 47:
                              return (
                                (t.prev = 47), (t.t0 = t.catch(38)), (window.location.href = a), t.abrupt('return', !1)
                              );
                            case 51:
                              if (
                            ...
                            case 61:
                              (X = Y.asPath),
                                Y.matchedPage &&
                                  Y.resolvedHref &&
                                  ((H = Y.resolvedHref), (F.pathname = A(H)), (o = O.formatWithValidation(F))),
                                (t.next = 67);
                              break;
                            case 65:
                              (F.pathname = U(H, V)),
                            ...
                            case 89:
                              ...
                              return (
                                (window.location.href = K.destination), t.abrupt('return', new Promise(function () {}))
                              );
                            case 94:
                            ...
                            case 145:
                              return (
                                ...
                                (t.next = 153),
                                this.set(
                                  l(l({}, v), {}, { route: Q, pathname: H, query: z, asPath: k, isFallback: !1 }),
                                  ue,
                      ...
                      function (t) {
                        for (;;)
                          switch ((t.prev = t.next)) {
                            ...
                            case 13:
                              if ((d = { props: undefined, Component: s, styleSheets: l, err: r, error: r }).props) {
                                t.next = 25;
                                break;
                              }
                              return (
                                (t.prev = 15), (t.next = 18), this.getInitialProps(s, { err: r, pathname: o, query: a })
                              );
                            case 18:
                        ...
                        for (;;)
                          switch ((e.prev = e.next)) {
                            ...
                            case 26:
                              ...
                              break;
                            case 31:
                              (P = _.__flight__), (_.pageProps = Object.assign({}, _.pageProps, { __flight__: P }));
                            case 33:
                            ...
                            case 38:
                              return (
                                (e.prev = 38),
                                (e.t1 = e.catch(0)),
                                e.abrupt('return', this.handleRouteInfoError(h.getProperError(e.t1), r, o, a, u))
                              );
                            case 41:
                            case 'end':
                              return e.stop();
                            ...
                            case 21:
                              return (
                                (s = _.parseRelativeUrl(
                                  m.normalizeLocalePath(M(u.rewrite) ? T(u.rewrite) : u.rewrite, this.locales).pathname
                                )),
                            ...
                            case 25:
                              ...
                              return (
                                (h = f.removePathTrailingSlash(
                                  m.normalizeLocalePath(M(u.redirect) ? T(u.redirect) : u.redirect, this.locales)
                                    .pathname
                                )),
                                (v = W(this, h, h)),
                                (y = v.url),
          ...
          a(e, [
            ...
            },
            {
              ...
              value: function () {
                ...
                if (
                  (null !== this.slugName &&
                    o.push.apply(o, n(this.children.get('[]')._smoosh(''.concat(t, '[').concat(this.slugName, ']/')))),
                  !this.placeholder)
                ) {
                  var a = '/' === t ? '/' : t.slice(0, -1);
                ...
                return (
                  null !== this.restSlugName &&
                    o.push.apply(
                      o,
                      n(this.children.get('[...]')._smoosh(''.concat(t, '[...').concat(this.restSlugName, ']/')))
                    ),
                  ...
                  if (o.startsWith('[') && o.endsWith(']')) {
                    var a = function (e, t) {
                        ...
                        r.forEach(function (e) {
                          if (e === t)
                            throw new Error(
                              'You cannot have the same slug name "'.concat(t, '" repeat within a single dynamic path')
                            );
