  ...
  [4],
  {
    ...
    '6Hpx': function (e, t, n) {
              ...
              P(
                ...
                g
                  ? P(
                      ...
                      P(k, { noAnimation: !0, fill: i.colors.logo })
                    )
                  : P(
                      F,
                      { href: '/' },
                      P('a', { style: { width: '86px', height: '20px' } }, P(k, { fill: i.colors.logo }))
                    )
              ),
              P(
                v.a,
      ...
      function q(e) {
        ...
        return $(
          W,
          { className: t || '', hasBackground: i, hasBackgroundMobile: c, hideSidebar: u },
          r ? (u ? null : $(T, { noBg: c, pageData: r })) : null,
          $(
            Z,
            {
              className: 'wrapper',
            ...
            m
              ...
              : $(
                  ...
                  null,
                  l ? null : $(h, null),
                  o ? $(X, { className: u ? 'centered' : '' }, o) : null,
                  f
                    ? null
                    : $(Y, {
                        onClick: function () {
            ...
            m && u && o ? $(X, { className: u ? 'centered' : '' }, o) : null,
            $(U, { className: 'content '.concat(o ? 'has-action' : '') }, n)
          )
        );
      }
      var W = o.d.div.withConfig({ displayName: 'container__StyledContainer', componentId: 'u3fn7h-0' })(
        ...
        X = o.d.div.withConfig({ displayName: 'container__ActionWrapper', componentId: 'u3fn7h-4' })(
          [
            'position:absolute;top:32px;left:32px;&.centered{left:max(32px,calc(50% - (608px / 2)));@media (max-width:',
      ...
      t.a = function (e) {
        ...
        return u(
          ...
          u(
            ...
            u(
              s.b.g,
              { variants: { initial: { scale: 1 }, animate: { scale: 1.2 } }, transition: l.c },
              u('path', {
                fill: i.colors.primary,
    ...
    V0DS: function (e, t, n) {
      ...
      var r = { duration: 0.5, ease: [0.43, 0.13, 0.23, 0.96] },
        a = function (e) {},
        o = { duration: 0.5, delay: 0.35 },
        i = {
          initial: { opacity: 0, scaleY: 0, originY: 'bottom' },
          animate: { opacity: 1, scaleY: 1, originY: 'bottom' },
          exit: { opacity: 0, scaleY: 0, originY: 'bottom' },
        },
        c = { rest: { scale: 1 }, hover: { scale: 0.95 }, tap: { scale: 1.0125 } },
        s = { initial: { opacity: 0, x: '100%' }, animate: { opacity: 1, x: '0%' }, exit: { opacity: 0, x: '-100%' } };
    },
    Vt1p: function (e, t, n) {
      'use strict';
      n.d(t, 'a', function () {
