                  ...
                  this.scrollToHash(),
                    Q.isSsr &&
                      ...
                      Q.replace(
                        Q.pathname +
                          '?' +
                          String(E.assign(E.urlQueryToSearchParams(Q.query), new URLSearchParams(location.search))),
                        W,
                        { _h: 1, shallow: !j }
                      );
                },
              ...
              function (e) {
                for (;;)
                  switch ((e.prev = e.next)) {
                    case 0:
                      return (
                        s.length > 0 && void 0 !== s[0] ? s[0] : {}, (e.next = 4), J.routeLoader.whenEntrypoint('/_app')
                      );
                    case 4:
