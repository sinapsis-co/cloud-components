      ...
      var D = (function () {
        function t(e, r, n, o) {
          ...
          (this.asPath = b ? e : n),
            ...
            (this.isSsr = !0),
            (this.isFallback = g),
            (this.isReady = !(!self.__NEXT_DATA__.gssp && !self.__NEXT_DATA__.gip && (b || self.location.search))),
            '//' !== n.substr(0, 2) &&
              this.changeState(
                'replaceState',
                          ...
                          switch ((e.prev = e.next)) {
                            ...
                            case 18:
                              if (
                                ...
                                (a = P(b(S(a) ? k(a) : a, i.locale, this.defaultLocale))),
                            ...
                            case 50:
                              if (
                                ((x = this._resolveHref(x, A)).pathname !== C &&
                                  ((C = x.pathname), (o = (0, h.formatWithValidation)(x))),
                            ...
                            case 62:
                              if (((N = _(k(N), this.locale)), !(0, p.isDynamicRoute)(M))) {
                                e.next = 78;
                                break;
                              }
                              if (
                            ...
                            case 77:
                              B
                                ? (a = (0, h.formatWithValidation)(
                                    Object.assign({}, U, { pathname: G.result, query: L(I, G.params) })
                                  ))
                                : Object.assign(I, q);
                            case 78:
                              return (
                                ...
                                (e.prev = 79),
                                (e.next = 82),
                                this.getRouteInfo(M, C, I, P(b(N, this.locale)), g)
                              );
                            case 82:
                              if (
                                ((V = e.sent),
                              ...
                              if (
                                ((Z = (0, d.parseRelativeUrl)(Q)), this._resolveHref(Z, A, !1), !A.includes(Z.pathname))
                              ) {
                                e.next = 93;
                                break;
                              }
                            ...
                            case 108:
                              return (
                                ...
                                this.changeState(r, o, a, i),
                                (e.next = 113),
                                this.set(M, C, I, w, V, u || (i.scroll ? { x: 0, y: 0 } : null)).catch(function (t) {
