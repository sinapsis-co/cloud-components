(window.webpackJsonp_N_E = window.webpackJsonp_N_E || []).push([
  [13],
  {
    '+8Ae': function (t, n, e) {
      ...
      var w = o.e.svg.withConfig({ displayName: 'trash__TrashSvg', componentId: 'sc-10bnm6z-0' })(['']),
        y = o.e.path.withConfig({ displayName: 'trash__TrashPath', componentId: 'sc-10bnm6z-1' })(
          ['fill:', ';'],
          function (t) {
            return t.theme.colors.primary;
          }
      ...
      function k(t) {
        var n = t.className,
          e = t.onClick;
        return C(_, { className: n }, C(b, { onClick: e }));
      }
      var _ = Object(o.e)(u.a).withConfig({
