  ...
  [7],
  {
    ...
    ufqH: function (e, r, t) {
      ...
      function I(e) {
        ...
        if (d) {
          var l =
              'rgb(' + s(parseInt('' + d[1], 10), parseInt('' + d[2], 10) / 100, parseInt('' + d[3], 10) / 100) + ')',
            I = m.exec(l);
          if (!I) throw new u(4, r, l);
          return {
            red: parseInt('' + I[1], 10),
    ...
    zoQI: function (e, r, t) {
      ...
      function u(e) {
        var r = e.children,
          ...
          i = void 0 !== o && o,
          u = e.className,
          l = Object(a.a)(e, ['children', 'variant', 'fullWidth', 'className']);
        return c(d, Object(n.a)({ variant: f, fullWidth: i, className: u || '' }, l), r);
      }
