  ...
  [12],
  {
    '/kYb': function (t, n, e) {
      ...
      var g = Object(i.e)(a.a).withConfig({
        ...
        v = i.e.h6.withConfig({ displayName: 'back-navigation__Title', componentId: 'kfmxgl-1' })(
    ...
    GNXZ: function (t, n, e) {
      ...
      var l = e('foSv'),
        ...
        v = Object(p.d)(['top:22px;font-size:14px;font-weight:400;line-height:16px;color:', ';'], function (t) {
          return t.theme.colors.primary;
        }),
      ...
      var s = a.e.path.withConfig({ displayName: 'search__Handle', componentId: 'sc-1pnq8jm-0' })(
        ...
        g = Object(a.e)(function (t) {
          return h(
            ...
            t.disabled ? null : h(v, null, h(w, { arrowUp: t.listOpen }))
          );
        ...
        v = a.e.div.withConfig({ displayName: 'dropdown-header__IconWrapper', componentId: 'tlc708-3' })([
