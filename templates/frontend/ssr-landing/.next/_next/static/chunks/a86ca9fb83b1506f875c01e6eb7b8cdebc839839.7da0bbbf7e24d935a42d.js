  ...
  [6],
  {
                    ...
                    for (var l = 0, c = f.length; l < c; l++) {
                      ...
                      if (r.props.hasOwnProperty(u))
                        if ('charSet' === u) n.has(u) ? (a = !1) : n.add(u);
                          ...
                          var s = r.props[u],
                            d = o[u] || new Set();
                          ('name' === u && i) || !d.has(s) ? (d.add(s), (o[u] = d)) : (a = !1);
                        }
                    }
                }
                return a;
            ...
            Object(o.useEffect)(function () {
              var e = function (e) {
                ...
                t = function (t) {
                  var n, o, a, i;
                  console.log('event: ', t),
                    console.log('event: ', null === (n = t.data) || void 0 === n ? void 0 : n.origin),
                    console.log('event.data.payload: ', e(t.data.payload)),
                    (
                      (null === (o = 'http://localhost:3000,https://app.development.trac.co')
                        ? void 0
                        : o.split(',')) || []
                    ).includes(t.origin) &&
                      ...
                      void 0 !== i &&
                      i.payload &&
                      (console.log('event.origin: ', t.origin),
                      console.log('window.parent: ', window.parent),
                      window.parent &&
                        (console.log('come_here1: '),
                        window.parent.postMessage({ origin: 'trac-artist-site', ready: !0 }, t.origin)),
                      r(e(t.data.payload)));
                };
              return (
    ...
    zoQI: function (e, t, n) {
      ...
      function c(e) {
        ...
        return l(u, Object(o.a)({ variant: a, fullWidth: p, className: c || '' }, s), t);
      }
