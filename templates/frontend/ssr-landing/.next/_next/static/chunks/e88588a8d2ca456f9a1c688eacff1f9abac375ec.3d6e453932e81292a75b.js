  ...
  [5],
  {
    ...
    Neuu: function (n, t, r) {
      ...
      function c(n) {
        ...
        var b = Math.pow(m, 2) * p;
        return { stiffness: b, damping: 2 * h * Math.sqrt(p * b) };
      }
      function s(n, t) {
      ...
      function p(n) {
        var t = n.from,
          ...
          i = void 0 === a ? 2 : a,
          f = n.restDelta,
          p = Object(e.d)(n, ['from', 'to', 'restSpeed', 'restDelta']),
          m = { done: !1, value: r },
          b = (function (n) {
      ...
      p.needsInterpolation = function (n, t) {
        ...
        function C() {
          D++,
            'reverse' === y
              ...
              : ((l = tn(l, N, O)), 'mirror' === y && q.flipTarget()),
            (P = !1),
            x && x();
        }
        function k(n) {
          if ((T || (n = -n), (l += n), !P)) {
            var t = q.next(Math.max(0, l));
            (u = t.value), a && (u = a(u)), (P = T ? t.done : l <= 0);
          }
          null === S || void 0 === S || S(u),
            P &&
              (0 === D && ((null !== N && void 0 !== N) || (N = l)),
              D < m
                ? (function (n, t, r, e) {
                    return e ? n >= t + r : n <= -r;
                  })(l, N, O, T) && C()
      ...
      var ln = function (n, t, r) {
        ...
        bn = function (n, t, r) {
          return ((pn(t, r) * n + hn(t, r)) * n + mn(t)) * n;
        },
        yn = function (n, t, r) {
          return 3 * pn(t, r) * n * n + 2 * hn(t, r) * n + mn(t);
        };
      var gn = 0.1;
      function On(n, t, r, e) {
        if (n === t && r === e) return U;
