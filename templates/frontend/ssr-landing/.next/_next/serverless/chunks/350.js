...
exports.ids = [350];
exports.modules = {
  /***/ 9231: /***/ (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
    /* harmony export */ __webpack_require__.d(__webpack_exports__, {
      /* harmony export */ Z: () => /* binding */ Button,
      /* harmony export */
    });
    /* harmony import */ var polished__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(2521);
      ...
      ({ variant, theme }) =>
        variant === 'accent'
          ? (0, styled_components__WEBPACK_IMPORTED_MODULE_2__ /* .css */.iv)(
              ...
              theme.colors.accent,
              ({ theme }) => (0, polished__WEBPACK_IMPORTED_MODULE_3__ /* .rgba */.m4)(theme.colors.accent, 0.2),
              theme.colors.accentHover
            )
          : (0, styled_components__WEBPACK_IMPORTED_MODULE_2__ /* .css */.iv)(
              ['color:#111111;background-color:', ';box-shadow:10px 10px 20px ', ';&:hover{background-color:', ';}'],
              theme.colors.secondary,
              ({ theme }) => (0, polished__WEBPACK_IMPORTED_MODULE_3__ /* .rgba */.m4)(theme.colors.secondary, 0.05),
