...
exports.ids = [930];
exports.modules = {
  /***/ 9936: /***/ (module, __unused_webpack_exports, __webpack_require__) => {
    (() => {
      var e = {
        213: (e) => {
          'use strict';
          function _interpolate(e, r, n) {
            ...
            return t.reduce(function (e, o, s) {
              ...
              if (i === '\\') {
                ...
                a = Object.prototype.hasOwnProperty.call(r, l) ? r[l] : n.parsed[l] || o[1] || '';
                if (o.length > 1 && a) {
                  const r = t[s + 1];
                  t[s + 1] = '';
                  e = e.replace(r, '');
          ...
          function expand(e) {
            ...
            for (const n in e.parsed) {
              const t = Object.prototype.hasOwnProperty.call(r, n) ? r[n] : e.parsed[n];
      ...
      (() => {
        ...
        __nccwpck_require__.d(n, { processEnv: () => processEnv, loadEnvConfig: () => loadEnvConfig });
        var e = __nccwpck_require__(147);
        var r = __nccwpck_require__.n(e);
        var t = __nccwpck_require__(17);
        var o = __nccwpck_require__.n(t);
        var s = __nccwpck_require__(397);
        var c = __nccwpck_require__(213);
        let i = undefined;
        let a = [];
        function processEnv(e, r, n = console) {
          var o;
          if (process.env.__NEXT_PROCESSED_ENV || e.length === 0) {
            return process.env;
          }
          process.env.__NEXT_PROCESSED_ENV = 'true';
          const i = Object.assign({}, process.env);
          const a = {};
          for (const _ of e) {
            try {
              let e = {};
              e.parsed = s.Q(_.contents);
              e = (0, c.j)(e);
              if (e.parsed) {
                n.info(`Loaded env from ${t.join(r || '', _.path)}`);
              }
              for (const r of Object.keys(e.parsed || {})) {
                if (typeof a[r] === 'undefined' && typeof i[r] === 'undefined') {
                  a[r] = (o = e.parsed) === null || o === void 0 ? void 0 : o[r];
                }
              }
            } catch (e) {
              n.error(`Failed to load env from ${t.join(r || '', _.path)}`, e);
            }
          }
          return Object.assign(process.env, a);
        }
        function loadEnvConfig(r, n, o = console) {
          if (i) return { combinedEnv: i, loadedEnvFiles: a };
          const s = 'production' === 'test';
          const c = s ? 'test' : n ? 'development' : 'production';
          const _ = [`.env.${c}.local`, c !== 'test' && `.env.local`, `.env.${c}`, '.env'].filter(Boolean);
          for (const n of _) {
            const s = t.join(r, n);
            try {
          ...
          i = processEnv(a, r, o);
          return { combinedEnv: i, loadedEnvFiles: a };
        }
      })();
      module.exports = n;
    })();
  ...
  /***/ 908: /***/ (__unused_webpack_module, exports) => {
    'use strict';
  ...
  /***/ 5241: /***/ (__unused_webpack_module, exports) => {
    'use strict';
      ...
      if (domainItems) {
        ...
        for (const item of domainItems) {
          ...
          const domainHostname =
            (ref = item.domain) === null || ref === void 0 ? void 0 : ref.split(':')[0].toLowerCase();
  ...
  /***/ 6124: /***/ (__unused_webpack_module, exports) => {
    'use strict';
  ...
  /***/ 78: /***/ (__unused_webpack_module, exports) => {
    'use strict';
  ...
  /***/ 1358: /***/ (__unused_webpack_module, exports, __webpack_require__) => {
    'use strict';
    ...
    var _utils = __webpack_require__(5052);

    var _normalizePathSep = __webpack_require__(2446);
  ...
  /***/ 2446: /***/ (__unused_webpack_module, exports) => {
    'use strict';
  ...
  /***/ 7952: /***/ (__unused_webpack_module, exports, __webpack_require__) => {
    ...
    var _routeRegex = __webpack_require__(1672);
  ...
  /***/ 5052: /***/ (__unused_webpack_module, exports, __webpack_require__) => {
    ...
    var _getMiddlewareRegex = __webpack_require__(7952);

    var _routeMatcher = __webpack_require__(1864);

    var _routeRegex = __webpack_require__(1672);

    var _sortedRoutes = __webpack_require__(6532);

    var _isDynamic = __webpack_require__(8356);

    /***/
  },

  /***/ 8356: /***/ (__unused_webpack_module, exports) => {
    'use strict';
  ...
  /***/ 6481: /***/ (__unused_webpack_module, exports, __webpack_require__) => {
    ...
    var _utils = __webpack_require__(1716);
  ...
  /***/ 1157: /***/ (__unused_webpack_module, exports, __webpack_require__) => {
    'use strict';
    ...
    var _parseRelativeUrl = __webpack_require__(6481);
  ...
  /***/ 8350: /***/ (__unused_webpack_module, exports, __webpack_require__) => {
    ...
    function getPathMatch(path, options) {
      ...
      const matcher = (0, _pathToRegexp).regexpToFunction(
        (options === null || options === void 0 ? void 0 : options.regexModifier)
  ...
  /***/ 8362: /***/ (__unused_webpack_module, exports, __webpack_require__) => {
    ...
    var _escapeRegexp = __webpack_require__(908);

    var _parseUrl = __webpack_require__(1157);
    ...
    function matchHas(req, has, query) {
      ...
      const allMatch = has.every((hasItem) => {
        ...
        switch (hasItem.type) {
          ...
          case 'host': {
            const { host } = (req === null || req === void 0 ? void 0 : req.headers) || {}; // remove port from host if present
  ...
  /***/ 567: /***/ (__unused_webpack_module, exports) => {
    'use strict';
  ...
  /***/ 1864: /***/ (__unused_webpack_module, exports, __webpack_require__) => {
    'use strict';
  ...
  /***/ 6532: /***/ (__unused_webpack_module, exports) => {
    'use strict';
  ...
  /***/ 1716: /***/ (__unused_webpack_module, exports) => {
    'use strict';
  ...
  /***/ 6249: /***/ (__unused_webpack_module, exports, __webpack_require__) => {
    ...
    var _utils1 = __webpack_require__(1716);
    var _node1 = __webpack_require__(6094);
    function getApiHandler(ctx) {
      const { pageModule, encodedPreviewProps, pageIsDynamic } = ctx;
      const { handleRewrites, handleBasePath, dynamicRouteMatcher, normalizeDynamicRouteParams } = (0, _utils).getUtils(
        ctx
      );
        ...
        try {
          ...
          if (pageIsDynamic) {
            const result = normalizeDynamicRouteParams(
              trustQuery ? parsedUrl.query : dynamicRouteMatcher(parsedUrl.pathname)
            );
            params = result.params;
          }
          await (0, _node).apiResolver(
            req.originalRequest,
  ...
  /***/ 8992: /***/ (__unused_webpack_module, exports, __webpack_require__) => {
    'use strict';
    ...
    var _pathMatch = __webpack_require__(8350);
    var _routeRegex = __webpack_require__(1672);
    var _routeMatcher = __webpack_require__(1864);
    ...
    var _detectDomainLocale = __webpack_require__(5241);
    var _denormalizePagePath = __webpack_require__(1358);
    var _cookie = _interopRequireDefault(__webpack_require__(722));
    var _constants = __webpack_require__(8461);
    ...
    function getUtils({ page, i18n, basePath, rewrites, pageIsDynamic }) {
      ...
      function handleRewrites(req, parsedUrl) {
        ...
        const matchesPage = () => {
          return (
            fsPathname === page ||
            (dynamicRouteMatcher === null || dynamicRouteMatcher === void 0 ? void 0 : dynamicRouteMatcher(fsPathname))
          );
        };
      ...
      function handleLocale(req, res, parsedUrl, routeNoAssetPath, shouldNotRedirect) {
        ...
        try {
          acceptPreferredLocale =
            i18n.localeDetection !== false
              ? (0, _acceptHeader).acceptLanguage(req.headers['accept-language'], i18n.locales)
              : detectedLocale;
        } catch (_) {
        ...
        if (detectedDomain) {
          ...
          if (matchedDomain && matchedDomain.domain !== detectedDomain.domain) {
            localeDomainRedirect = `http${matchedDomain.http ? '' : 's'}://${matchedDomain.domain}/${
        ...
        if (
          ...
          i18n.localeDetection !== false &&
          (localeDomainRedirect || shouldAddLocalePrefix || shouldStripDefaultLocale)
        ) {
        ...
        detectedLocale =
          localePathResult.detectedLocale || (detectedDomain && detectedDomain.defaultLocale) || defaultLocale;
        return {
          defaultLocale,
          detectedLocale,
          routeNoAssetPath,
  ...
  /***/ 8008: /***/ (module, __unused_webpack_exports, __webpack_require__) => {
    (() => {
      'use strict';
      var e = {
        474: (e, t, r) => {
          ...
          function entitytag(e) {
            ...
            var r = typeof e === 'string' ? Buffer.byteLength(e, 'utf8') : e.length;
          ...
          function etag(e, t) {
            ...
            var r = isstats(e);
            var i = t && typeof t.weak === 'boolean' ? t.weak : r;
            if (!r && typeof e !== 'string' && !Buffer.isBuffer(e)) {
              throw new TypeError('argument entity must be string, Buffer, or fs.Stats');
            }
            var n = r ? stattag(e) : entitytag(e);
            return i ? 'W/' + n : n;
          }
          function isstats(e) {
            ...
            return (
              ...
              typeof e === 'object' &&
              'ctime' in e &&
              a.call(e.ctime) === '[object Date]' &&
              'mtime' in e &&
              a.call(e.mtime) === '[object Date]' &&
              'ino' in e &&
              typeof e.ino === 'number' &&
              'size' in e &&
          ...
          function stattag(e) {
            ...
            var r = e.size.toString(16);
            return '"' + r + '-' + t + '"';
          }
        },
        113: (e) => {
          e.exports = __webpack_require__(6113);
        },
        147: (e) => {
          e.exports = __webpack_require__(7147);
        },
    ...
    (() => {
      var e = {
        ...
        505: (e) => {
          ...
          var r = { ES256: getParamSize(256), ES384: getParamSize(384), ES512: getParamSize(521) };
        ...
        48: (e, r, t) => {
          ...
          var l = t(270);
          var p = t(664);
          var y = ['RS256', 'RS384', 'RS512', 'ES256', 'ES384', 'ES512', 'HS256', 'HS384', 'HS512', 'none'];
          if (i) {
          ...
          var d = {
            ...
            algorithm: { isValid: o.bind(null, y), message: '"algorithm" must be a valid string enum value' },
            ...
            mutatePayload: { isValid: s, message: '"mutatePayload" must be a boolean' },
          };
          var v = {
          ...
          var g = ['expiresIn', 'notBefore', 'noTimestamp', 'audience', 'issuer', 'subject', 'jwtid'];
          e.exports = function (e, r, t, i) {
            ...
            var s = Object.assign({ alg: t.algorithm || 'HS256', typ: o ? 'JWT' : undefined, kid: t.keyid }, t.header);
            function failure(e) {
              if (i) {
                return i(e);
              }
            ...
            Object.keys(b).forEach(function (r) {
              ...
              if (typeof t[r] !== 'undefined') {
                if (typeof e[n] !== 'undefined') {
                  return failure(
                    new Error('Bad "options.' + r + '" option. The payload already has an "' + n + '" property.')
                  );
                }
                e[n] = t[r];
              }
        ...
        591: (e, r, t) => {
          ...
          var l = ['RS256', 'RS384', 'RS512'];
          var p = ['HS256', 'HS384', 'HS512'];
          if (u) {
          ...
          e.exports = function (e, r, t, u) {
            ...
            return m(g, function (r, o) {
              ...
              if (!t.algorithms) {
                t.algorithms =
                  ~o.toString().indexOf('BEGIN CERTIFICATE') || ~o.toString().indexOf('BEGIN PUBLIC KEY')
                    ? c
              ...
              if (t.audience) {
                ...
                var w = Array.isArray(h.aud) ? h.aud : [h.aud];
              ...
              if (t.issuer) {
                var x =
                  (typeof t.issuer === 'string' && h.iss !== t.issuer) ||
                  (Array.isArray(t.issuer) && t.issuer.indexOf(h.iss) === -1);
                if (x) {
              ...
              if (t.complete === true) {
                var O = b.signature;
                return y(null, { header: g, payload: h, signature: O });
              }
              return y(null, h);
            });
          };
        ...
        54: (e, r, t) => {
          ...
          function createPSSKeyVerifier(e) {
            return function verify(r, t, n) {
              ...
              i.update(r);
              return i.verify(
                { key: n, padding: a.constants.RSA_PKCS1_PSS_PADDING, saltLength: a.constants.RSA_PSS_SALTLEN_DIGEST },
                t,
                'base64'
              );
            };
        ...
        300: (e) => {
          'use strict';
          e.exports = __webpack_require__(4300);
        },
        113: (e) => {
          'use strict';
          e.exports = __webpack_require__(6113);
        ...
        849: (e) => {
          'use strict';
          e.exports = __webpack_require__(4096);
        },
        781: (e) => {
          'use strict';
  ...
  /***/ 6003: /***/ (module, __unused_webpack_exports, __webpack_require__) => {
    (() => {
      var __webpack_modules__ = {
        282: (e, p, a) => {
          ...
          function convert(e, p, a, d) {
            ...
            if (a === p) {
              ...
              try {
                m = convertIconv(e, p, a);
              } catch (d) {
                console.error(d);
                try {
                  m = convertIconvLite(e, p, a);
                } catch (p) {
                  console.error(p);
                  m = e;
                }
          ...
          function convertIconv(e, p, a) {
            var d, m;
            m = new i(a, p + '//TRANSLIT//IGNORE');
            d = m.convert(e);
            return d.slice(0, d.length);
          }
        ...
        315: (e, p, a) => {
          ...
          function DBCSCodec(e, p) {
            ...
            if (e.encodeSkipVals)
              for (var d = 0; d < e.encodeSkipVals.length; d++) {
                var r = e.encodeSkipVals[d];
                if (typeof r === 'number') l[r] = true;
                else for (var o = r.from; o <= r.to; o++) l[o] = true;
              }
            this._fillEncodeTable(0, 0, l);
            if (e.encodeAdd) {
              for (var n in e.encodeAdd)
                if (Object.prototype.hasOwnProperty.call(e.encodeAdd, n))
                  this._setEncodeChar(n.charCodeAt(0), e.encodeAdd[n]);
            }
            ...
            if (typeof e.gb18030 === 'function') {
              ...
              var u = (this.decodeTables[c] = s.slice(0));
              var v = this.decodeTables.length;
              var f = (this.decodeTables[v] = s.slice(0));
              for (var d = 129; d <= 254; d++) {
                var h = t - this.decodeTables[0][d];
                var w = this.decodeTables[h];
                for (var o = 48; o <= 57; o++) w[o] = t - c;
              }
              for (var d = 129; d <= 254; d++) u[d] = t - v;
              for (var d = 48; d <= 57; d++) f[d] = m;
            }
          }
          ...
          DBCSCodec.prototype._addDecodeChunk = function (e) {
            ...
            for (var d = 1; d < e.length; d++) {
              ...
              if (typeof i === 'string') {
                ...
                throw new Error(
                  "Incorrect type '" + typeof i + "' given in " + this.encodingName + ' at chunk ' + e[0]
                );
            }
            if (p > 255)
              throw new Error('Incorrect chunk in ' + this.encodingName + ' at addr ' + e[0] + ': too long' + p);
          };
          ...
          DBCSCodec.prototype._fillEncodeTable = function (e, p, a) {
            ...
            for (var i = 0; i < 256; i++) {
              ...
              var s = p + i;
              if (a[s]) continue;
              if (m >= 0) this._setEncodeChar(m, s);
              else if (m <= t) this._fillEncodeTable(t - m, s << 8, a);
              else if (m <= l) this._setEncodeSequence(this.decodeTableSeq[l - m], s);
            }
          };
          ...
          DBCSDecoder.prototype.write = function (e) {
            var p = d.alloc(e.length * 2),
              ...
              n;
            if (r > 0) s = d.concat([s, e.slice(0, 10)]);
            for (var c = 0, u = 0; c < e.length; c++) {
              ...
              if (n >= 0) {
                ...
                var f = o >= 0 ? e.slice(o, c + 1) : s.slice(o + r, c + 1 + r);
                var h = (f[0] - 129) * 12600 + (f[1] - 48) * 1260 + (f[2] - 129) * 10 + (f[3] - 48);
                var w = findIdx(this.gb18030.gbChars, h);
                n = this.gb18030.uChars[w] + h - this.gb18030.gbChars[w];
              } else if (n <= t) {
                a = t - n;
                continue;
              } else if (n <= l) {
                var b = this.decodeTableSeq[l - n];
                for (var _ = 0; _ < b.length - 1; _++) {
                  n = b[_];
                  p[u++] = n & 255;
                  p[u++] = n >> 8;
                }
                ...
                throw new Error('iconv-lite internal error: invalid decoding table value ' + n + ' at ' + a + '/' + v);
              if (n > 65535) {
                n -= 65536;
                var g = 55296 + Math.floor(n / 1024);
                p[u++] = g & 255;
                p[u++] = g >> 8;
                n = 56320 + (n % 1024);
              }
            ...
            this.nodeIdx = a;
            this.prevBuf = o >= 0 ? e.slice(o) : s.slice(o + r);
        ...
        231: (e, p, a) => {
          'use strict';
          var d = [a(905), a(486), a(788), a(647), a(278), a(760), a(315), a(820)];
        ...
        486: (e, p, a) => {
          ...
          Utf16Decoder.prototype.write = function (e) {
            if (!this.decoder) {
              ...
              var e = d.concat(this.initialBytes),
                p = detectEncoding(e, this.options.defaultEncoding);
          ...
          function detectEncoding(e, p) {
            var a = p || 'utf-16le';
            if (e.length >= 2) {
              if (e[0] == 254 && e[1] == 255) a = 'utf-16be';
              else if (e[0] == 255 && e[1] == 254) a = 'utf-16le';
              else {
                var d = 0,
                  i = 0,
                  m = Math.min(e.length - (e.length % 2), 64);
                for (var l = 0; l < m; l += 2) {
                  if (e[l] === 0 && e[l + 1] !== 0) i++;
                  if (e[l] !== 0 && e[l + 1] === 0) d++;
                }
                if (i > d) a = 'utf-16be';
                else if (i < d) a = 'utf-16le';
              }
            }
            return a;
          }
        ...
        788: (e, p, a) => {
            ...
            return d.from(
              e.replace(
                ...
                function (e) {
                  return (
                    '+' +
                    (e === '+' ? '' : this.iconv.encode(e, 'utf16-be').toString('base64').replace(/=+$/, '')) +
                    '-'
                  );
                }.bind(this)
              )
          ...
          Utf7IMAPDecoder.prototype.write = function (e) {
              ...
              if (!i) {
                ...
                if (!n[e[l]]) {
                  if (l == a && e[l] == r) {
                    ...
                    var t = m + e.slice(a, l).toString().replace(/,/g, '/');
            ...
            if (!i) {
              ...
              var t = m + e.slice(a).toString().replace(/,/g, '/');
        ...
        340: (e, p, a) => {
          ...
          e.exports = function (e) {
            var p = undefined;
            e.supportsNodeEncodingsExtension = !(d.from || new d(0) instanceof Uint8Array);
            e.extendNodeEncodings = function extendNodeEncodings() {
              ...
              d.isNativeEncoding = function (e) {
                return e && i[e.toLowerCase()];
              };
              var m = a(300).SlowBuffer;
              p.SlowBufferToString = m.prototype.toString;
              m.prototype.toString = function (a, i, m) {
                a = String(a || 'utf8').toLowerCase();
                if (d.isNativeEncoding(a)) return p.SlowBufferToString.call(this, a, i, m);
                if (typeof i == 'undefined') i = 0;
                if (typeof m == 'undefined') m = this.length;
                return e.decode(this.slice(i, m), a);
              };
              p.SlowBufferWrite = m.prototype.write;
              m.prototype.write = function (a, i, m, l) {
                if (isFinite(i)) {
                  if (!isFinite(m)) {
                    l = m;
                    m = undefined;
                ...
                if (d.isNativeEncoding(l)) return p.SlowBufferWrite.call(this, a, i, m, l);
                if (a.length > 0 && (m < 0 || i < 0)) throw new RangeError('attempt to write beyond buffer bounds');
                var r = e.encode(a, l);
                if (r.length < m) m = r.length;
                r.copy(this, i, 0, m);
                return m;
              };
              p.BufferIsEncoding = d.isEncoding;
              d.isEncoding = function (p) {
                return d.isNativeEncoding(p) || e.encodingExists(p);
              };
              p.BufferByteLength = d.byteLength;
              d.byteLength = m.byteLength = function (a, i) {
                i = String(i || 'utf8').toLowerCase();
                if (d.isNativeEncoding(i)) return p.BufferByteLength.call(this, a, i);
                return e.encode(a, i).length;
              };
              p.BufferToString = d.prototype.toString;
              d.prototype.toString = function (a, i, m) {
                a = String(a || 'utf8').toLowerCase();
                if (d.isNativeEncoding(a)) return p.BufferToString.call(this, a, i, m);
                if (typeof i == 'undefined') i = 0;
                if (typeof m == 'undefined') m = this.length;
                return e.decode(this.slice(i, m), a);
              };
              p.BufferWrite = d.prototype.write;
              d.prototype.write = function (a, i, m, l) {
                var t = i,
                  s = m,
                  r = l;
                if (isFinite(i)) {
                ...
                l = String(l || 'utf8').toLowerCase();
                if (d.isNativeEncoding(l)) return p.BufferWrite.call(this, a, t, s, r);
                i = +i || 0;
                var n = this.length - i;
                if (!m) {
                  m = n;
              ...
              if (e.supportsStreams) {
                var l = a(781).Readable;
                p.ReadableSetEncoding = l.prototype.setEncoding;
                l.prototype.setEncoding = function setEncoding(p, a) {
                  this._readableState.decoder = e.getDecoder(p, a);
                  this._readableState.encoding = p;
                };
                l.prototype.collect = e._collect;
              }
            };
            e.undoExtendNodeEncodings = function undoExtendNodeEncodings() {
              ...
              delete d.isNativeEncoding;
              var i = a(300).SlowBuffer;
              i.prototype.toString = p.SlowBufferToString;
              i.prototype.write = p.SlowBufferWrite;
              d.isEncoding = p.BufferIsEncoding;
              d.byteLength = p.BufferByteLength;
              d.prototype.toString = p.BufferToString;
              d.prototype.write = p.BufferWrite;
              if (e.supportsStreams) {
                var m = a(781).Readable;
                m.prototype.setEncoding = p.ReadableSetEncoding;
                delete m.prototype.collect;
              }
              p = undefined;
            };
          };
        ...
        330: (e, p, a) => {
          ...
          m.getCodec = function getCodec(e) {
            if (!m.encodings) m.encodings = a(231);
          ...
          var l = typeof process !== 'undefined' && process.versions && process.versions.node;
          if (l) {
            var t = l.split('.').map(Number);
            if (t[0] > 0 || t[1] >= 10) {
              a(9)(m);
            }
            a(340)(m);
        ...
        9: (e, p, a) => {
          ...
          var d = a(300).Buffer,
            i = a(781).Transform;
          e.exports = function (e) {
            e.encodeStream = function encodeStream(p, a) {
              return new IconvLiteEncoderStream(e.getEncoder(p, a), a);
            };
            e.decodeStream = function decodeStream(p, a) {
              return new IconvLiteDecoderStream(e.getDecoder(p, a), a);
            };
          ...
          function IconvLiteEncoderStream(e, p) {
            this.conv = e;
            p = p || {};
            p.decodeStrings = false;
            i.call(this, p);
          }
          ...
          function IconvLiteDecoderStream(e, p) {
            this.conv = e;
            p = p || {};
            p.encoding = this.encoding = 'utf8';
            i.call(this, p);
          }
          ...
          IconvLiteDecoderStream.prototype._transform = function (e, p, a) {
            if (!d.isBuffer(e)) return a(new Error('Iconv decoding stream needs buffers as its input.'));
            try {
        ...
        197: (e, p, a) => {
            ...
            if (e instanceof d) {
              e.on('error', function (e) {
                const a =
                  e.name === 'AbortError'
                    ? e
                    : new FetchError(`Invalid response body while trying to fetch ${p.url}: ${e.message}`, 'system', e);
                p[u].error = a;
              });
            }
          }
          Body.prototype = {
            ...
            blob() {
              ...
              return consumeBody.call(this).then(function (p) {
                return Object.assign(new Blob([], { type: e.toLowerCase() }), { [o]: p });
              });
            },
            json() {
              var e = this;
              return consumeBody.call(this).then(function (p) {
                try {
                  ...
                  return Body.Promise.reject(
                    new FetchError(`invalid json response body at ${e.url} reason: ${p.message}`, 'invalid-json')
                  );
                }
              });
            },
            ...
            return new Body.Promise(function (d, l) {
              ...
              p.on('end', function () {
                ...
                try {
                  ...
                  l(
                    new FetchError(`Could not create Buffer from response body for ${e.url}: ${p.message}`, 'system', p)
                  );
                }
              });
            });
          ...
          class Response {
            constructor() {
              ...
              this[g] = { url: p.url, status: a, statusText: p.statusText || S[a], headers: d, counter: p.counter };
            }
            get url() {
              return this[g].url || '';
            }
          ...
          class Request {
            constructor(e) {
              ...
              Body.call(this, i, { timeout: p.timeout || e.timeout || 0, size: p.size || e.size || 0 });
          ...
          function getNodeRequestOptions(e) {
            ...
            const a = new Headers(e[N].headers);
            if (!a.has('Accept')) {
              a.set('Accept', '*/*');
            }
            ...
            return Object.assign({}, p, { method: e.method, headers: exportNodeCompatibleHeaders(a), agent: m });
          }
                ...
                if (fetch.isRedirect(e.statusCode)) {
                  ...
                  try {
                    ...
                    if (l.redirect !== 'manual') {
                      m(
                        new FetchError(`uri requested responds with an invalid redirect URL: ${d}`, 'invalid-redirect')
                      );
                      finalize();
                      return;
                    }
                  ...
                  switch (l.redirect) {
                    ...
                    case 'follow':
                      ...
                      if (
                        e.statusCode === 303 ||
                        ((e.statusCode === 301 || e.statusCode === 302) && l.method === 'POST')
                      ) {
                        d.method = 'GET';
                        d.body = undefined;
          ...
          function validateLabel(e, p) {
            ...
            for (var l = 0; l < i; ++l) {
              ...
              if (
                ...
                (processing === m.NONTRANSITIONAL && s[1] !== 'valid' && s[1] !== 'deviation')
              ) {
                a = true;
                break;
              }
        ...
        398: (e, p, a) => {
          'use strict';
          p.URL = a(656)['interface'];
          p.serializeURL = a(706).serializeURL;
          p.serializeURLOrigin = a(706).serializeURLOrigin;
          p.basicURLParse = a(706).basicURLParse;
          p.setTheUsername = a(706).setTheUsername;
          p.setThePassword = a(706).setThePassword;
          p.serializeHost = a(706).serializeHost;
          p.serializeInteger = a(706).serializeInteger;
          p.parseURL = a(706).parseURL;
        },
        706: (e, p, a) => {
          'use strict';
          const d = a(477);
          const i = a(528);
          const m = { ftp: 21, file: null, gopher: 70, http: 80, https: 443, ws: 80, wss: 443 };
            ...
            if (e === 47 || e === 92) {
              ...
              if (isNaN(e)) {
                ...
                if (
                  ...
                  (this.input.length - this.pointer - 1 >= 2 && !r.has(this.input[this.pointer + 2]))
                ) {
                  this.url.host = this.base.host;
                  this.url.path = this.base.path.slice();
          ...
          e.exports.serializeURLOrigin = function (p) {
            switch (p.scheme) {
              ...
              case 'ws':
              case 'wss':
                return serializeOrigin({ scheme: p.scheme, host: p.host, port: p.port });
              case 'file':
                return 'file://';
              default:
                return 'null';
        ...
        685: (e) => {
          'use strict';
          e.exports = __webpack_require__(3685);
        },
        687: (e) => {
          'use strict';
          e.exports = __webpack_require__(5687);
        },
        477: (e) => {
          'use strict';
          e.exports = __webpack_require__(5477);
        },
        781: (e) => {
          'use strict';
          e.exports = __webpack_require__(2781);
        ...
        576: (e) => {
          'use strict';
          e.exports = __webpack_require__(1576);
        },
        310: (e) => {
          'use strict';
          e.exports = __webpack_require__(7310);
        },
        796: (e) => {
          'use strict';
          e.exports = __webpack_require__(9796);
        },
        802: (e) => {
          'use strict';
  ...
  /***/ 5229: /***/ (__unused_webpack_module, exports) => {
    'use strict';
    ...
    (() => {
      var __webpack_modules__ = {
        363: (module, __unused_webpack_exports, __nccwpck_require__) => {
           ...
           * MIT Licensed
           */
          var callSiteToString = __nccwpck_require__(651).callSiteToString;
          var eventListenerCount = __nccwpck_require__(651).eventListenerCount;
          ...
          function DeprecationError(e, t, r) {
            ...
            Object.defineProperty(a, 'message', { configurable: true, enumerable: false, value: t, writable: true });
            ...
            Object.defineProperty(a, 'namespace', { configurable: true, enumerable: false, value: e, writable: true });
        ...
        651: (e, t, r) => {
          ...
          lazyProperty(e.exports, 'callSiteToString', function callSiteToString() {
            ...
            Error.stackTraceLimit = e;
            return i[0].toString ? toString : r(273);
          });
          lazyProperty(e.exports, 'eventListenerCount', function eventListenerCount() {
            return a.listenerCount || r(606);
          });
          function lazyProperty(e, t, r) {
            function get() {
              var a = r();
              Object.defineProperty(e, t, { configurable: true, enumerable: true, value: a });
              return a;
            }
          ...
          DBCSDecoder.prototype.write = function (e) {
            ...
            for (var p = 0, l = 0; p < e.length; p++) {
              ...
              if (u >= 0) {
                ...
                throw new Error('iconv-lite internal error: invalid decoding table value ' + u + ' at ' + r + '/' + h);
              if (u > 65535) {
                u -= 65536;
        ...
        231: (e, t, r) => {
          'use strict';
          var a = [r(905), r(486), r(788), r(647), r(278), r(760), r(315), r(820)];
        ...
        330: (e, t, r) => {
          ...
          o.getCodec = function getCodec(e) {
            if (!o.encodings) o.encodings = r(231);
        ...
        542: (e, t, r) => {
          ...
          function getDecoder(e) {
            ...
            try {
              ...
              throw i(415, 'specified encoding unsupported', { encoding: e, type: 'encoding.unsupported' });
            }
          }
          ...
          function readStream(e, t, r, a, o) {
            ...
            if (a !== null && r !== null && r > a) {
              return done(
                i(413, 'request entity too large', { expected: r, length: r, limit: a, type: 'entity.too.large' })
              );
            }
            var s = e._readableState;
            if (e._decoder || (s && (s.encoding || s.decoder))) {
              return done(i(500, 'stream encoding should not be set', { type: 'stream.encoding.set' }));
            }
            var f = 0;
            var d;
            try {
            ...
            function onData(e) {
              ...
              f += e.length;
              if (a !== null && f > a) {
                done(i(413, 'request entity too large', { limit: a, received: f, type: 'entity.too.large' }));
              } else if (d) {
                u += d.write(e);
              } else {
                u.push(e);
        ...
        719: (e, t, r) => {
          ...
          function createClientErrorConstructor(e, t, r) {
            ...
            function ClientError(e) {
              ...
              Object.defineProperty(c, 'message', { enumerable: true, configurable: true, value: t, writable: true });
              Object.defineProperty(c, 'name', { enumerable: false, configurable: true, value: a, writable: true });
              return c;
            }
            c(ClientError, e);
        ...
        666: (e) => {
          'use strict';
          e.exports = __webpack_require__(1026);
        },
        17: (e) => {
          'use strict';
          e.exports = __webpack_require__(1017);
      ...
      if (typeof __nccwpck_require__ !== 'undefined') __nccwpck_require__.ab = __dirname + '/';
      var __webpack_exports__ = __nccwpck_require__(542);
      module.exports = __webpack_exports__;
    })();
    ...
    (() => {
      var e = {
        ...
        349: (e, r, t) => {
          class Range {
            ...
            intersects(e, r) {
              ...
              return this.set.some(
                (t) =>
                  isSatisfiable(t, r) &&
                  e.set.some((e) => isSatisfiable(e, r) && t.every((t) => e.every((e) => t.intersects(e, r))))
              );
            }
            test(e) {
              if (!e) {
          ...
          const o = t(23);
          const n = t(828);
          const { re: i, t: a, comparatorTrimReplace: l, tildeTrimReplace: c, caretTrimReplace: p } = t(962);
        ...
        828: (e, r, t) => {
          const s = t(23);
          const { MAX_LENGTH: o, MAX_SAFE_INTEGER: n } = t(585);
        ...
        585: (e) => {
          ...
          const o = 16;
          e.exports = { SEMVER_SPEC_VERSION: r, MAX_LENGTH: t, MAX_SAFE_INTEGER: s, MAX_SAFE_COMPONENT_LENGTH: o };
        },
        23: (e) => {
          const r =
        ...
        143: (e) => {
          ...
          e.exports = { compareIdentifiers: compareIdentifiers, rcompareIdentifiers: rcompareIdentifiers };
        },
        962: (e, r, t) => {
          const { MAX_SAFE_COMPONENT_LENGTH: s } = t(585);
          const o = t(23);
          r = e.exports = {};
          const n = (r.re = []);
          const i = (r.src = []);
          ...
          createToken(
            'MAINVERSION',
            `(${i[a.NUMERICIDENTIFIER]})\\.` + `(${i[a.NUMERICIDENTIFIER]})\\.` + `(${i[a.NUMERICIDENTIFIER]})`
          );
          createToken(
            'MAINVERSIONLOOSE',
          ...
          createToken(
            'PRERELEASELOOSE',
            `(?:-?(${i[a.PRERELEASEIDENTIFIERLOOSE]}(?:\\.${i[a.PRERELEASEIDENTIFIERLOOSE]})*))`
          );
          ...
          createToken(
            'HYPHENRANGELOOSE',
            `^\\s*(${i[a.XRANGEPLAINLOOSE]})` + `\\s+-\\s+` + `(${i[a.XRANGEPLAINLOOSE]})` + `\\s*$`
          );
          createToken('STAR', '(<|>)?=?\\s*\\*');
  ...
  /***/ 7554: /***/ (__unused_webpack_module, exports) => {
    'use strict';
  ...
  /***/ 9833: /***/ (__unused_webpack_module, exports) => {
    'use strict';
  ...
  /***/ 6114: /***/ (__unused_webpack_module, exports, __webpack_require__) => {
    'use strict';
  ...
  /***/ 5005: /***/ (__unused_webpack_module, exports, __webpack_require__) => {
    ...
    async function apiResolver(req, res, query, resolverModule, apiContext, propagateError, dev, page) {
      ...
      try {
        ...
        var ref3;
        const responseLimit =
          (ref3 = (ref1 = config.api) === null || ref1 === void 0 ? void 0 : ref1.responseLimit) !== null &&
          ref3 !== void 0
            ? ref3
            : true;
        const externalResolver =
          ((ref2 = config.api) === null || ref2 === void 0 ? void 0 : ref2.externalResolver) || false;
        // Parsing of cookies
        (0, _index).setLazyProp(
          ...
          'cookies',
          (0, _index).getCookieParser(req.headers)
        );
        ...
        apiRes.end = (...args) => {
          ...
          if (responseLimit && contentLength >= maxContentLength) {
            console.warn(
              `API response for ${req.url} exceeds ${_bytes.default.format(
                maxContentLength
    ...
    async function unstable_revalidate(urlPath, opts, req, context) {
      ...
      try {
        if (context.trustHostHeader) {
          ...
          if (
            (cacheHeader === null || cacheHeader === void 0 ? void 0 : cacheHeader.toUpperCase()) !== 'REVALIDATED' &&
          ...
          const {
            ...
            res: mockRes,
            streamPromise,
          } = (0, _mockRequest).mockRequest(urlPath, revalidateHeaders, 'GET');
  ...
  /***/ 8482: /***/ (__unused_webpack_module, exports, __webpack_require__) => {
    'use strict';
  ...
  /***/ 7098: /***/ (__unused_webpack_module, exports, __webpack_require__) => {
    'use strict';
  ...
  /***/ 7157: /***/ (__unused_webpack_module, __unused_webpack_exports, __webpack_require__) => {
    'use strict';
  ...
  /***/ 5705: /***/ (__unused_webpack_module, exports, __webpack_require__) => {
    'use strict';
  ...
  /***/ 9330: /***/ (__unused_webpack_module, exports) => {
    'use strict';
