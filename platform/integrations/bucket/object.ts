...
export const bucketPutObject = async <TracingMeta extends Record<string, string> = Record<string, string>>(
  ...
  return Tracing.traceableOp('PutObject', 'FAULT_S3_PUT_OBJECT', params.Bucket!, cmd, {
    key: params.Key!,
    ...tracingMeta,
  });
};
...
export const bucketHeadObject = async <TracingMeta extends Record<string, string> = Record<string, string>>(
  ...
  return Tracing.traceableOp('HeadObject', 'FAULT_S3_HEAD_OBJECT', params.Bucket!, cmd, {
    key: params.Key!,
    ...tracingMeta,
  });
};
...
export const bucketGetObject = async <TracingMeta extends Record<string, string> = Record<string, string>>(
  ...
  return Tracing.traceableOp('GetObject', 'FAULT_S3_GET_OBJECT', params.Bucket!, cmd, {
    key: params.Key!,
    ...tracingMeta,
  });
};
...
export const bucketDeleteObject = async <TracingMeta extends Record<string, string> = Record<string, string>>(
  ...
  return Tracing.traceableOp('DeleteObject', 'FAULT_S3_DELETE_OBJECT', params.Bucket!, cmd, {
    key: params.Key!,
    ...tracingMeta,
  });
};
